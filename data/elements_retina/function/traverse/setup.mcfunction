...
execute if score $single_call retina.__variable__ matches 1.. run function elements_retina:__private__/if_else/2
execute anchored eyes positioned ^ ^ ^ summon minecraft:marker run function elements_retina:__private__/anonymous/0
...
execute store result storage elements_retina:data offset_Y double 0.0020833 run scoreboard players get $offset_Y retina.__variable__
function elements_retina:__private__/anonymous/1 with storage elements_retina:data

data modify storage elements_retina:output Target set value 'NONE'
data modify storage elements_retina:output Distance set from storage elements_retina:input MaxRecursionDepth
data modify storage elements_retina:output HitEntityHead set value false
data remove storage elements_retina:output TargetedBlock
data remove storage elements_retina:output TargetedEntity
data remove storage elements_retina:output PlacingPosition
data remove storage elements_retina:output ContactSurface
data remove storage elements_retina:output ContactCoordinates
data remove storage elements_retina:output HitFace
...
execute store result score $max_depth retina.__variable__ run data get storage elements_retina:input MaxRecursionDepth
scoreboard players operation $max_depth retina.__variable__ *= $max_depth retina.__variable__
execute store result score $override_executing retina.__variable__ run data get storage elements_retina:input OverrideExecutingEntity
data remove storage elements_retina:input OverrideExecutingEntity
execute if data storage elements_retina:input ExpandEntityHitboxes store result score $expand_entity_hitboxes retina.__variable__ run data get storage elements_retina:input ExpandEntityHitboxes 480
...
data remove storage elements_retina:input ExpandEntityHitboxes
...
execute unless data storage elements_retina:input SetupContext summon minecraft:marker run function elements_retina:__private__/anonymous/2
execute store result score $input_pitch retina.__variable__ run data get storage elements_retina:input SetupContext.Rotation[1] 10
execute store result score $input_yaw retina.__variable__ run data get storage elements_retina:input SetupContext.Rotation[0] 10
execute store result score $X retina.__variable__ run data get storage elements_retina:input SetupContext.Pos[0] 480
execute store result score $Y retina.__variable__ run data get storage elements_retina:input SetupContext.Pos[1] 480
execute store result score $Z retina.__variable__ run data get storage elements_retina:input SetupContext.Pos[2] 480
execute store result score $overflow_check_X retina.__variable__ run data get storage elements_retina:input SetupContext.Pos[0] 1
execute store result score $overflow_check_Z retina.__variable__ run data get storage elements_retina:input SetupContext.Pos[2] 1
...
function elements_retina:traverse/loop
execute if score $hit_block retina.__variable__ matches 1.. run function elements_retina:storage/block
execute if score $hit_entity retina.__variable__ matches 1.. run function elements_retina:storage/entity
function #elements_retina:on_hit

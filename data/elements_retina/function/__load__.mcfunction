...
execute unless score __math__.seed retina.__variable__ matches -2147483648..2147483647 run function elements_retina:__private__/math_random/setup
...
data merge storage elements_retina:input {HorizontalCount:1b,VerticalCount:1b,CenteredCount:0b,SpreadFactor:[100,100],EndpointEntity:0b}
execute unless data storage elements_retina:input MaxRecursionDepth run data merge storage elements_retina:input {MaxRecursionDepth:50}
execute unless data storage elements_retina:input TargetBlocks run data merge storage elements_retina:input {TargetBlocks:true}
execute unless data storage elements_retina:input TargetEntities run data merge storage elements_retina:input {TargetEntities:true}
data merge storage elements_retina:output {ContactCoordinates:[],ContactSurface:[],Distance:0.0d,HitFace:"",PlacingPosition:[],Target:"",TargetedBlock:[]}
execute store success score $old_version_installed retina.__variable__ run scoreboard players add * retina 1
execute if score $old_version_installed retina.__variable__ matches 1.. run function elements_retina:__private__/if_else/33
return 1
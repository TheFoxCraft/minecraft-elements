...
execute if score $horizontal_count retina.__variable__ matches 10 run function elements_retina:__private__/if_else/0
...
function elements_retina:__private__/math_random/main
...
execute if score $vertical_count retina.__variable__ matches 10 run function elements_retina:__private__/if_else/1
scoreboard players operation __math__.rng.bound retina.__variable__ = $spread_most retina.__variable__
scoreboard players operation __math__.rng.bound retina.__variable__ -= $spread_least retina.__variable__
scoreboard players add __math__.rng.bound retina.__variable__ 1
function elements_retina:__private__/math_random/main

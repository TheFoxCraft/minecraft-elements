...
execute if score .server elements_stage_6_boss_status matches 1 unless entity @e[tag=stage-6_boss] in elements:stage-6_bossroom run give @a[distance=0..,nbt={Inventory:[{id:"minecraft:mace"}]},gamemode=!spectator] breeze_rod 5

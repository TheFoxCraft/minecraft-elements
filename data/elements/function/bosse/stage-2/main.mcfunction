...
execute if score .server elements_stage_2_boss_status matches 1 unless entity @e[tag=stage-2_boss] if score .server elements_custom-items_shop_boss-frucht_remain_stage-2 matches 1 in elements:stage-2_bossroom run setblock 0 101 -1 chest[facing=east]{LootTable:"elements:stage-2_boss_key"} replace
execute if score .server elements_stage_2_boss_status matches 1 unless entity @e[tag=stage-2_boss] if score .server elements_custom-items_shop_boss-frucht_remain_stage-2 matches 0 in elements:stage-2_bossroom run setblock 0 101 -1 chest[facing=east]{LootTable:"elements:items/boss_key/stage_2"} replace
execute if score .server elements_stage_2_boss_status matches 1 unless entity @e[tag=stage-2_boss] if score .server elements_custom-items_shop_boss-frucht_remain_stage-2 matches 1 run scoreboard players set .server elements_custom-items_shop_boss-frucht_remain_stage-2 0

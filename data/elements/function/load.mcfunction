...
scoreboard objectives add elements_enderchest_interface_click_shop_ocean_bossfrucht dummy
...
#scoreboard objectives add elements_enderchest_interface_click_shop_sky_ dummy

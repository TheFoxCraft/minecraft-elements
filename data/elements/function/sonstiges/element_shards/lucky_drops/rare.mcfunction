...
xp add @s 500 levels
tellraw @s ["",{"translate":"elements.main.other.[","color": "gray"},{"translate":"elements.main.other.elements","color": "light_purple"},{"translate":"elements.main.other.]","color": "gray"},"Lucky Drop! ",{"translate": "elements.main.rarities.rare","color": "dark_blue"}," - ",{"text": "500 Level","color": "green"}]
execute if score @s elements_settings_luckydrops_sound matches ..2 at @s run playsound elements:luckydrop.rare master @s ~ ~ ~ 0.5

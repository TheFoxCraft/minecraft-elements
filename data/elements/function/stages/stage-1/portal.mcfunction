...
execute as @a[tag=stage-1_portal,scores={elements_enderchest_level_tp=..1}] run tellraw @s [{"text": "Server: ","color": "yellow"},{"text": "Du kannst den Bossraum erst betreten, wenn du das Teleport-Modul freigeschalten hast!","color": "white"}]
...
execute as @a[tag=stage-1_portal,scores={elements_enderchest_level_tp=2}] if score #server elements_stage_1_boss_status matches 1.. run tellraw @s [{"text": "Server: ","color": "yellow"},{"text": "Ein Boss-Kampf läuft derzeit! Bitte warte, bis dieser abgeschlossen ist!","color": "white"}]
execute as @a[tag=stage-1_portal,scores={elements_enderchest_level_tp=2}] if score #server elements_stage_1_boss_status matches 1.. at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
...
execute as @a[tag=stage-1_boss_spawn] unless entity @s[nbt={SelectedItem:{id:"minecraft:blue_ice",components:{"minecraft:custom_model_data":1}}}] run tellraw @s [{"text": "Server: ","color": "yellow"},{"text": "Du benötigst das Bossitem vom Steinmetz!","color": "white"}]
...
execute as @a[tag=stage-1_boss_spawn,nbt={SelectedItem:{id:"minecraft:blue_ice",components:{"minecraft:custom_model_data":1}}}] if score #server elements_stage_1_boss_loot_count matches 1.. run tellraw @s [{"text": "Server: ","color": "yellow"},{"text": "In der Loot-Kiste befinden sich Items!","color": "white"}]
...
execute as @a[tag=stage-1_boss_spawn,nbt={SelectedItem:{id:"minecraft:blue_ice",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_shop_boss-frucht_remain_stage-1=1}] if score #server elements_stage_1_boss_loot_count matches 0 run tellraw @s [{"text": "Server: ","color": "yellow"},{"text": "Deine letze Bossfrucht wurde verbraucht!","color": "red"}]
execute as @a[tag=stage-1_boss_spawn,nbt={SelectedItem:{id:"minecraft:blue_ice",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_shop_boss-frucht_remain_stage-1=2..}] if score #server elements_stage_1_boss_loot_count matches 0 run tellraw @s [{"text": "Server: ","color": "yellow"},{"text": "Bossfrucht angewandt!!","color": "white"}]
execute as @a[tag=stage-1_boss_spawn,nbt={SelectedItem:{id:"minecraft:blue_ice",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_shop_boss-frucht_remain_stage-1=1..}] if score #server elements_stage_1_boss_loot_count matches 0 run scoreboard players set #server elements_custom-items_shop_boss-frucht_remain_stage-1 1
execute as @a[tag=stage-1_boss_spawn,nbt={SelectedItem:{id:"minecraft:blue_ice",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_shop_boss-frucht_remain_stage-1=1..}] if score #server elements_stage_1_boss_loot_count matches 0 run scoreboard players remove @s elements_custom-items_shop_boss-frucht_remain_stage-1 1

#stats-ende
execute as @a[tag=stage-1_boss_spawn,nbt={SelectedItem:{id:"minecraft:blue_ice",components:{"minecraft:custom_model_data":1}}}] if score #server elements_stage_1_boss_loot_count matches 0 in elements:stage-1_bossroom run tellraw @a[distance=0..] [{"text": "Server: ","color": "yellow"},{"text": "Der Rießige Silberfisch wurde gespawnt!","color": "white"}]

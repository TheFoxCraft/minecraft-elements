...
# Final Boss
execute as @a[predicate=elements:is_in_hub] at @s if entity @e[distance=..20,type=text_display,nbt={Tags:["final-boss_portal_status"]}] run function elements:stages/portals/final-boss
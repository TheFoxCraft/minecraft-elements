...
execute as @a[tag=stage-2_boss_spawn,nbt={SelectedItem:{id:"minecraft:dark_oak_sapling",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_shop_boss-frucht_remain_stage-2=1}] if score #server elements_stage_2_boss_loot_count matches 0 run tellraw @s [{"text": "Server: ","color": "yellow"},{"text": "Deine letze Bossfrucht wurde verbraucht!","color": "red"}]
execute as @a[tag=stage-2_boss_spawn,nbt={SelectedItem:{id:"minecraft:dark_oak_sapling",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_shop_boss-frucht_remain_stage-2=2..}] if score #server elements_stage_2_boss_loot_count matches 0 run tellraw @s [{"text": "Server: ","color": "yellow"},{"text": "Bossfrucht angewandt!!","color": "white"}]
execute as @a[tag=stage-2_boss_spawn,nbt={SelectedItem:{id:"minecraft:dark_oak_sapling",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_shop_boss-frucht_remain_stage-2=1..}] if score #server elements_stage_2_boss_loot_count matches 0 run scoreboard players set #server elements_custom-items_shop_boss-frucht_remain_stage-2 1
execute as @a[tag=stage-2_boss_spawn,nbt={SelectedItem:{id:"minecraft:dark_oak_sapling",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_shop_boss-frucht_remain_stage-2=1..}] if score #server elements_stage_2_boss_loot_count matches 0 run scoreboard players remove @s elements_custom-items_shop_boss-frucht_remain_stage-2 1

...
execute as @a[tag=stage-2_portal,scores={elements_enderchest_level_tp=..1}] run tellraw @s ["",{"text": "[","color": "gray"},{"text": "Elements","color": "light_purple"},{"text": "] ","color": "gray"},{"text": "Du kannst den Bossraum erst betreten, wenn du das Teleport-Modul freigeschalten hast!","color": "white"}]
...
execute as @a[tag=stage-2_portal,scores={elements_enderchest_level_tp=2,elements_custom_doubleclick_cooldown=1..}] if score .server elements_stage_2_boss_status matches 1.. in elements:stage-2_bossroom positioned 0 100 0 run spreadplayers 0 0 1 7 under 105 false @s
execute as @a[tag=stage-2_portal,scores={elements_enderchest_level_tp=2,elements_custom_doubleclick_cooldown=1..}] if score .server elements_stage_2_boss_status matches 1.. run tag @s add elements_boss_spectator
execute as @a[tag=stage-2_portal,scores={elements_enderchest_level_tp=2,elements_custom_doubleclick_cooldown=1..}] if score .server elements_stage_2_boss_status matches 1.. run gamemode spectator @s
execute as @a[tag=stage-2_portal,scores={elements_enderchest_level_tp=2,elements_custom_doubleclick_cooldown=1..}] if score .server elements_stage_2_boss_status matches 1.. at @s run playsound entity.enderman.teleport master @s
execute as @a[tag=stage-2_portal,scores={elements_enderchest_level_tp=2,elements_custom_doubleclick_cooldown=0}] if score .server elements_stage_2_boss_status matches 1.. run tellraw @s ["",{"text": "[","color": "gray"},{"text": "Elements","color": "light_purple"},{"text": "] ","color": "gray"},{"text": "Ein Boss-Kampf läuft derzeit! Klicke erneut um als Zuschauer beizutreten!","color": "white"}]
execute as @a[tag=stage-2_portal,scores={elements_enderchest_level_tp=2,elements_custom_doubleclick_cooldown=0}] if score .server elements_stage_2_boss_status matches 1.. at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @a[tag=stage-2_portal,scores={elements_enderchest_level_tp=2,elements_custom_doubleclick_cooldown=0}] if score .server elements_stage_2_boss_status matches 1.. run scoreboard players set @s elements_custom_doubleclick_cooldown 40
...
execute in elements:stage-2_bossroom unless block 0 101 -1 minecraft:chest if block 0 101 -1 air if score .server elements_stage_2_boss_status matches 0 run setblock 0 101 -1 chest[facing=east]
...
execute as @a[tag=stage-2_boss_spawn] unless entity @s[nbt={SelectedItem:{id:"minecraft:dark_oak_sapling",components:{"minecraft:custom_model_data":1}}}] run tellraw @s ["",{"text": "[","color": "gray"},{"text": "Elements","color": "light_purple"},{"text": "] ","color": "gray"},{"text": "Du benötigst das Bossitem vom Förster!","color": "white"}]
...
#stats-ende
execute as @a[tag=stage-2_boss_spawn,nbt={SelectedItem:{id:"minecraft:dark_oak_sapling",components:{"minecraft:custom_model_data":1}}}] if score .server elements_stage_2_boss_loot_count matches 0 in elements:stage-2_bossroom run tellraw @a[distance=0..] ["",{"text": "[","color": "gray"},{"text": "Elements","color": "light_purple"},{"text": "] ","color": "gray"},{"text": "Die Rießige Plasma-Blaze wurde gespawnt!","color": "white"}]
execute as @a[tag=stage-2_boss_spawn,nbt={SelectedItem:{id:"minecraft:dark_oak_sapling",components:{"minecraft:custom_model_data":1}}}] if score .server elements_stage_2_boss_loot_count matches 0 in elements:stage-2_bossroom run summon blaze 0 102 0 {PersistenceRequired:1b,Health:512f,Tags:["stage-2_boss"],attributes:[{id:"minecraft:attack_damage",base:10},{id:"minecraft:follow_range",base:50},{id:"minecraft:max_health",base:512},{id:"minecraft:scale",base:3}],HandItems:[{id:"barrier",components:{enchantments:{"elements:projectile_invulnerablity":1}}},{}],HandDropChances:[0f,0f],CustomName:'{"text": "Plasma Blaze","color": "yellow"}',DeathLootTable:"minecraft:empty"}

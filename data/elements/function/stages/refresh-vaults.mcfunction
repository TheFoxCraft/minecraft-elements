...
execute in elements:hub positioned 57 100 9 if data block ~ ~ ~ server_data.rewarded_players as @e[type=item,distance=..2,nbt={Item:{components:{"minecraft:custom_data":{"vault_loot_needs_owner":1b}}}}] run function elements:stages/vaults/stage_2
execute in elements:hub positioned 57 100 -9 if data block ~ ~ ~ server_data.rewarded_players as @e[type=item,distance=..2,nbt={Item:{components:{"minecraft:custom_data":{"vault_loot_needs_owner":1b}}}}] run function elements:stages/vaults/stage_3

...
execute if score .server elements_spawn_levelbaum_timer_min matches 0 store result score .server elements_spawn_levelbaum_timer_min run random value 30..45

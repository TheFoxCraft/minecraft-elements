...
execute as @a[tag=spawn_levelbaum_task,scores={elements_inv_bonemeal=1..},nbt={SelectedItem:{id:"minecraft:bone_meal"}}] run scoreboard players add .server elements_spawn_levelbaum_task 1
execute as @a[tag=spawn_levelbaum_task,scores={elements_inv_bonemeal=1..},nbt={SelectedItem:{id:"minecraft:bone_meal"}}] run clear @s bone_meal 1
...
execute as @a[tag=spawn_levelbaum_level_player] if score .server elements_stage matches 3 run tellraw @s ["",{"translate":"elements.main.other.[","color": "gray"},{"translate":"elements.main.other.elements","color": "light_purple"},{"translate":"elements.main.other.]","color": "gray"},{"text": "Der Allay hat eine große Ladung Level gedroppt! "},{"text": "+1000 Level","color": "green"}]

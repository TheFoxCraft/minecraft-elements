...
$execute as @a[scores={elements_leaderboards_id-3_rang=6},limit=1] if score #server elements_leaderboards_id-3_rang_enable matches 5 if score @s elements_miningxp_mining_level > $(name_5) elements_miningxp_mining_level run function elements:sonstiges/get_name with entity @s
$execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1},limit=1] if score #server elements_leaderboards_id-3_rang_enable matches 5 if score @s elements_miningxp_mining_level > $(name_5) elements_miningxp_mining_level run scoreboard players set $(name_5) elements_leaderboards_id-3_rang 6
...
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1},limit=1] if score #server elements_leaderboards_id-3_rang_enable matches 5 run scoreboard players set @s elements_get-name_continue 0

execute as @a[scores={elements_leaderboards_id-3_rang=6}] if score #server elements_leaderboards_id-3_rang_enable matches 4 run function elements:sonstiges/get_name with entity @s
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 4 run data modify storage elements_leaderboard_id-3 name_5 set from storage elements_get-name name
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 4 run scoreboard players set #server elements_leaderboards_id-3_rang_enable 5
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 5 run scoreboard players set @s elements_get-name_continue 0

execute as @a[scores={elements_leaderboards_id-3_rang=6}] if score #server elements_leaderboards_id-3_rang_enable matches 3 run function elements:sonstiges/get_name with entity @s
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 3 run data modify storage elements_leaderboard_id-3 name_4 set from storage elements_get-name name
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 3 run scoreboard players set #server elements_leaderboards_id-3_rang_enable 4
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 4 run scoreboard players set @s elements_get-name_continue 0

execute as @a[scores={elements_leaderboards_id-3_rang=6}] if score #server elements_leaderboards_id-3_rang_enable matches 2 run function elements:sonstiges/get_name with entity @s
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 2 run data modify storage elements_leaderboard_id-3 name_3 set from storage elements_get-name name
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 2 run scoreboard players set #server elements_leaderboards_id-3_rang_enable 3
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 3 run scoreboard players set @s elements_get-name_continue 0

execute as @a[scores={elements_leaderboards_id-3_rang=6}] if score #server elements_leaderboards_id-3_rang_enable matches 1 run function elements:sonstiges/get_name with entity @s
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 1 run data modify storage elements_leaderboard_id-3 name_2 set from storage elements_get-name name
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 1 run scoreboard players set #server elements_leaderboards_id-3_rang_enable 2
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 2 run scoreboard players set @s elements_get-name_continue 0

execute as @a[scores={elements_leaderboards_id-3_rang=6}] if score #server elements_leaderboards_id-3_rang_enable matches 0 run function elements:sonstiges/get_name with entity @s
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 0 run data modify storage elements_leaderboard_id-3 name_1 set from storage elements_get-name name
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 0 run scoreboard players set #server elements_leaderboards_id-3_rang_enable 1
execute as @a[scores={elements_leaderboards_id-3_rang=6,elements_get-name_continue=1}] if score #server elements_leaderboards_id-3_rang_enable matches 1 run scoreboard players set @s elements_get-name_continue 0

...
execute as @a[scores={elements_custom-items_shop_hot-lava_cooldown=0},gamemode=!adventure,nbt={SelectedItem:{id:"minecraft:magma_block",components:{"minecraft:custom_model_data":1}}}] run fill ~5 ~10 ~5 ~-5 ~ ~-5 air replace stone
...
execute as @a[scores={elements_custom-items_shop_hot-lava_cooldown=0},gamemode=!adventure,nbt={SelectedItem:{id:"minecraft:magma_block",components:{"minecraft:custom_model_data":1}}}] run function elements:custom-items/shop/nether/hot_lava/main

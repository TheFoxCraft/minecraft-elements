...
execute as @s[scores={elements_custom-items_shop_magisches-wasser_cooldown=0},nbt={SelectedItem:{id:"minecraft:potion",components:{"minecraft:custom_model_data":13}}},gamemode=!adventure] run scoreboard players operation @s elements_custom-items_shop_magisches-wasser_damage += .server elements_fixed-value_1
execute as @s[scores={elements_custom-items_shop_magisches-wasser_cooldown=0},nbt={SelectedItem:{id:"minecraft:potion",components:{"minecraft:custom_model_data":13}}},gamemode=!adventure] at @s run function elements_retina:traverse/setup

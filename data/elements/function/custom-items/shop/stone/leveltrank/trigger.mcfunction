...
execute as @s[scores={elements_custom-items_shop_leveltrank_cooldown=0}] run scoreboard players add @s elements_custom-items_shop_leveltrank_timer_min 60
...
scoreboard players set @s elements_custom-items_shop_leveltrank_cooldown 2

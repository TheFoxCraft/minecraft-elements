...
tellraw @s[scores={elements_mana_mana-count=20..,elements_mana_item_messstab_cooldown=0}] ["",{"text": "Server: ","color": "yellow"},{"text": "Du hast zum Test 20 Mana verbraucht.","color": "gray"},"\n",{"text": "Deine Mana: "},{"score": {"name": "@s","objective": "elements_mana_mana-count"}},"/",{"score": {"name": "@s","objective": "elements_mana_mana-max"}},", Deine Mana-Regeneration: ",{"score": {"name": "@s","objective": "elements_mana_regeneration-per-sec"}}," pro Sekunde"]
tellraw @s[scores={elements_mana_mana-count=..19,elements_mana_item_messstab_cooldown=0}] ["",{"text": "Server: ","color": "yellow"},{"text": "Du hast keine 20 Mana zum Testen.","color": "gray"},"\n",{"text": "Deine Mana: "},{"score": {"name": "@s","objective": "elements_mana_mana-count"}},"/",{"score": {"name": "@s","objective": "elements_mana_mana-max"}},", Deine Mana-Regeneration: ",{"score": {"name": "@s","objective": "elements_mana_regeneration-per-sec"}}," pro Sekunde"]
...
scoreboard players set @s elements_mana_item_messstab_cooldown 5
...
execute as @s[scores={elements_mana_item_magische-schale_cooldown=0,elements_mana_mana-count=..99}] run title @s actionbar ["",{"text": "[","color": "gray"},{"text": "Elements","color": "light_purple"},{"text": "] ","color": "gray"},{"text": "Du hast keine 100 Mana","color": "red"},{"text": " (Aktuell: ","color": "red"},{"score": {"name": "@s","objective": "elements_mana_mana-count"},"color": "red"},{"text": ")","color": "red"}]
...
execute as @s[scores={elements_mana_item_magische-schale_cooldown=0,elements_mana_mana-count=100..}] run scoreboard players set @s elements_sonstiges_actionbar_pause 15
execute as @s[scores={elements_mana_item_magische-schale_cooldown=0,elements_mana_mana-count=100..}] run title @s actionbar ["",{"text": "[","color": "gray"},{"text": "Elements","color": "light_purple"},{"text": "] ","color": "gray"},{"text": "100 Mana verbraucht (Jetzt: "},{"score": {"name": "@s","objective": "elements_mana_mana-count"}},{"text": ")"}]

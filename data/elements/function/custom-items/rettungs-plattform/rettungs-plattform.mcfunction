...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:stone_pressure_plate",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_shop_rettungs-plattform_cooldown=0}] at @s store result score @s elements_custom-items_shop_rettungs-plattform_block-count if blocks ~3 ~-1 ~3 ~-3 ~-1 ~-3 ~-3 ~-1 ~-3 masked
...
execute if entity @s[nbt={SelectedItem:{id:"minecraft:stone_pressure_plate",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_shop_rettungs-plattform_cooldown=0}] run scoreboard players operation @s elements_custom-items_shop_rettungs-plattform_block-need -= @s elements_custom-items_shop_rettungs-plattform_block-count

...
execute as @s[scores={elements_custom-items_mystery_tp-schwert_cooldown=0},gamemode=adventure] run title @s actionbar ["",{"translate":"elements.main.other.[","color": "gray"},{"translate":"elements.main.other.elements","color": "light_purple"},{"translate":"elements.main.other.]","color": "gray"},{"text": "Du kannst das hier nicht verwenden!","color": "red"}]
...
execute as @s[scores={elements_custom-items_mystery_tp-schwert_cooldown=0,elements_mana_mana-count=..9},gamemode=!adventure] run title @s actionbar ["",{"translate":"elements.main.other.[","color": "gray"},{"translate":"elements.main.other.elements","color": "light_purple"},{"translate":"elements.main.other.]","color": "gray"},{"text": "Du hast keine 10 Mana","color": "red"},{"text": " (Aktuell: ","color": "red"},{"score": {"name": "@s","objective": "elements_mana_mana-count"},"color": "red"},{"text": ")","color": "red"}]

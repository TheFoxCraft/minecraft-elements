...
execute as @s[scores={elements_custom-items_mystery_barriere-stab_cooldown=0,elements_mana_mana-count=..199}] run title @s actionbar ["",{"text": "[","color": "gray"},{"text": "Elements","color": "light_purple"},{"text": "] ","color": "gray"},{"text": "Du hast keine 200 Mana","color": "red"},{"text": " (Aktuell: ","color": "red"},{"score": {"name": "@s","objective": "elements_mana_mana-count"},"color": "red"},{"text": ")","color": "red"}]
...
execute as @s[scores={elements_custom-items_mystery_barriere-stab_cooldown=0,elements_mana_mana-count=200..}] run scoreboard players set @s elements_sonstiges_actionbar_pause 15
execute as @s[scores={elements_custom-items_mystery_barriere-stab_cooldown=0,elements_mana_mana-count=200..}] run title @s actionbar ["",{"text": "[","color": "gray"},{"text": "Elements","color": "light_purple"},{"text": "] ","color": "gray"},{"text": "200 Mana verbraucht (Jetzt: "},{"score": {"name": "@s","objective": "elements_mana_mana-count"}},{"text": ")"}]

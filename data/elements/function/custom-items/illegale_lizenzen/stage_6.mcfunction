advancement revoke @s only elements:items/illegale_lizenzen/stage_6
...
execute as @s[scores={elements_custom-items_item-click_cooldown=0}] run scoreboard players add @s elements_farm-slots_stage-6_max-slots 10
execute as @s[scores={elements_custom-items_item-click_cooldown=0}] run clear @s paper[custom_model_data=6] 1

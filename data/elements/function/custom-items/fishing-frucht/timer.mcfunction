execute as @s[scores={elements_custom-items_shop_fishing-frucht_enable=1}] run scoreboard players remove @s elements_custom-items_shop_fishing-frucht_timer_sec 1
...
execute as @s[scores={elements_custom-items_shop_fishing-frucht_timer_h=0,elements_custom-items_shop_fishing-frucht_timer_min=0,elements_custom-items_shop_fishing-frucht_timer_sec=0,elements_custom-items_shop_fishing-frucht_enable=1}] run scoreboard players set @s elements_custom-items_shop_fishing-frucht_enable 0

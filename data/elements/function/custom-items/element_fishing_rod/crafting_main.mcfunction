...
execute as @e[type=item,nbt={OnGround:1b,Item:{id:"minecraft:oak_wood",components:{"minecraft:custom_model_data":1}}},scores={elements_custom-items_fishing_rod_crafting_sticks_cooldown=60..}] at @s if block ~ ~ ~ stonecutter run summon item ~ ~ ~ {Item:{id:"stick"},Tags:["elements_fishing_crafting_stick_2","elements_fishing_crafting_stick"],PickupDelay:50}

...
execute as @s[scores={elements_custom-items_boss-keks_stage-1_cooldown=0}] run tellraw @s ["",{"translate":"elements.main.other.[","color": "gray"},{"translate":"elements.main.other.elements","color": "light_purple"},{"translate":"elements.main.other.]","color": "gray"},{"text": "Boss-Keks angewandt! ","color": "white"},{"text": "+50 Level","color": "green"}]

...
execute as @s[prediacte=elements:is_in_stoneblock] at @s unless block ~ ~ ~ spruce_sapling run data modify storage elements_farmslots_stage_2_broken_slots Dim set value "Stone-Block"

...
execute as @s[scores={elements_enderchest_interface_clicked=1}] store result storage elements_rotation_dimension stone int 1 run scoreboard players get @s elements_enderchest_settings_rotation_stone
execute as @s[scores={elements_enderchest_interface_clicked=1}] run function elements:enderchest/settings/dimension_rotation/stone_tp with storage elements_rotation_dimension
...
execute as @s[scores={elements_enderchest_level_tp=1..2,elements_enderchest_interface_number=1,elements_enderchest_settings_tp-mode=1}] run item replace entity @s enderchest.21 with gray_stained_glass_pane[custom_name='{"color":"gray","text":"Stone Block","italic": false}',custom_model_data=2] 1
...
execute as @s[scores={elements_enderchest_interface_clicked=1}] store result storage elements_rotation_dimension sky int 1 run scoreboard players get @s elements_enderchest_settings_rotation_sky
execute as @s[scores={elements_enderchest_interface_clicked=1}] run function elements:enderchest/settings/dimension_rotation/sky_tp with storage elements_rotation_dimension
execute as @s[scores={elements_enderchest_interface_clicked=1}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1}] at @s run playsound minecraft:entity.enderman.teleport master @s ~ ~ ~ 100
execute as @s[scores={elements_enderchest_interface_clicked=1}] run xp add @s 0 points
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
kill @e[type=item,nbt={Item:{id:"minecraft:light_blue_stained_glass_pane",count:1,components:{"minecraft:custom_model_data":2}}}]
execute as @s[scores={elements_enderchest_level_tp=1..2,elements_enderchest_interface_number=1,elements_enderchest_settings_tp-mode=1}] run item replace entity @s enderchest.23 with light_blue_stained_glass_pane[custom_name='{"color":"blue","text":"Sky Block","italic": false}',custom_model_data=2] 1
...
execute as @s[scores={elements_enderchest_interface_clicked=1}] store result storage elements_rotation_dimension nether int 1 run scoreboard players get @s elements_enderchest_settings_rotation_nether
execute as @s[scores={elements_enderchest_interface_clicked=1}] run function elements:enderchest/settings/dimension_rotation/nether_tp with storage elements_rotation_dimension
execute as @s[scores={elements_enderchest_interface_clicked=1}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1}] at @s run playsound minecraft:entity.enderman.teleport master @s ~ ~ ~ 100
execute as @s[scores={elements_enderchest_interface_clicked=1}] run xp add @s 0 points
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
kill @e[type=item,nbt={Item:{id:"minecraft:red_stained_glass_pane",count:1,components:{"minecraft:custom_model_data":2}}}]
execute as @s[scores={elements_enderchest_level_tp=1..2,elements_enderchest_interface_number=1,elements_enderchest_settings_tp-mode=1}] run item replace entity @s enderchest.24 with red_stained_glass_pane[custom_name='{"color":"red","text":"Nether Block","italic": false}',custom_model_data=2] 1
...
execute as @s[scores={elements_enderchest_level_tp=1..2,elements_enderchest_interface_number=1,elements_enderchest_settings_tp-mode=1}] run item replace entity @s enderchest.20 with blue_stained_glass_pane[custom_name='{"color":"dark_blue","text":"Ocean Block","italic": false}',custom_model_data=2] 1
...
execute as @s[scores={elements_enderchest_level_tp=2,elements_enderchest_interface_number=1,elements_enderchest_settings_tp-mode=1}] run item replace entity @s enderchest.22 with nether_star[custom_name='{"color":"dark_purple","text":"HUB","italic": false}',custom_model_data=1] 1
execute as @s[scores={elements_enderchest_level_tp=2,elements_enderchest_interface_number=1,elements_enderchest_settings_tp-mode=2}] run item replace entity @s enderchest.23 with nether_star[custom_name='{"color":"dark_purple","text":"HUB","italic": false}',custom_model_data=1] 1
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_enderchest_settings_dimension=1}] in elements:stone run tp @s 0 100 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_enderchest_settings_dimension=2}] in elements:sky run tp @s 0 100 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_enderchest_settings_dimension=3}] in elements:nether run tp @s 0 100 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_enderchest_settings_dimension=4}] in elements:ocean run tp @s 0 61 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_enderchest_settings_dimension=5}] in elements:hub run tp @s 0 101 0
...
execute as @s[scores={elements_enderchest_level_tp=2,elements_enderchest_interface_number=1,elements_enderchest_settings_tp-mode=3,elements_enderchest_settings_dimension=5}] run item replace entity @s enderchest.21 with nether_star[custom_name='{"color":"dark_purple","text":"HUB","italic": false}',custom_model_data=2] 1
execute as @s[scores={elements_enderchest_level_tp=2,elements_enderchest_interface_number=1,elements_enderchest_settings_tp-mode=2..3}] run item replace entity @s enderchest.22 with ender_pearl[custom_name='{"color":"dark_purple","text":"Teleport!","italic": false}',custom_model_data=1] 1
...
execute as @s[scores={elements_enderchest_level_autocompact=1..,elements_enderchest_interface_number=1}] run item replace entity @s enderchest.0 with piston[custom_name='{"color":"gray","text":"Auto-Compactor","italic": false}',custom_model_data=1] 1
...
execute as @s[scores={elements_enderchest_level_upgradeschmiede=1,elements_enderchest_interface_number=1}] run item replace entity @s enderchest.8 with anvil[custom_name='{"color":"dark_purple","text":"Upgrade Schmiede","italic": false}',custom_model_data=1] 1
...
execute as @s[scores={elements_enderchest_level_enderchest=1,elements_enderchest_interface_number=1}] run item replace entity @s enderchest.2 with ender_chest[custom_name='{"color":"dark_purple","text":"Enderchest","italic": false}',custom_model_data=1] 1
...
execute as @s[scores={elements_enderchest_level_casino=1,elements_enderchest_interface_number=1}] run item replace entity @s enderchest.10 with diamond[custom_name='{"color":"gold","text":"Casino","italic": false}',custom_model_data=1] 1
...
execute as @s[scores={elements_enderchest_level_settings=0,elements_enderchest_interface_number=1,elements_rank_admin=1}] run item replace entity @s enderchest.18 with recovery_compass[custom_name='{"color":"light_purple","text":"Admin-Settings","italic": false}',custom_model_data=2] 1

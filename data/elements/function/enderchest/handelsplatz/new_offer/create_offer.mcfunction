...
scoreboard players operation @s elements_enderchest_handelsplatz_stats_tokens_spend_for_fine += @s elements_enderchest_handelsplatz_new_offer_price_fine
scoreboard players operation .server elements_enderchest_handelsplatz_stats_tokens_spend_for_fine += @s elements_enderchest_handelsplatz_new_offer_price_fine
...
data modify storage elements_handelsmarkt_offers Offers prepend from storage elements_handelsmarkt_offers New_Offer

scoreboard players add @s elements_enderchest_handelsplatz_stats_offers_created 1
scoreboard players add .server elements_enderchest_handelsplatz_stats_offers_created 1

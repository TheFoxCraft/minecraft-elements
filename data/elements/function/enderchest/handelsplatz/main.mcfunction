...
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=0}] run item replace entity @s enderchest.3 with oak_hanging_sign[custom_name='{"color":"gold","text": "Handelsplatz","italic": false}',lore=['{"text": "Du kannst hier eigene Items verkaufen,","color": "gray","italic": false}','{"text":"oder die Items der anderen Kaufen.","color": "gray","italic": false}','""','{"text":"Um dein Eigenes Item zu verkaufen klicke auf \\"Neues Angebot\\".","color": "gray","italic": false}','""','{"text":"Zum Kaufen klicke dich einfach durch die Seiten","color": "gray","italic": false}','{"text":"Angebote für die du genügend Tokens hast kannst du mit einem Klick kaufen.","color": "gray","italic": false}'],custom_model_data=1] 1

#Stone
execute as @a[scores={elements_enderchest_interface_number=8,elements_enderchest_settings_tp-mode=1}] store result score @s elements_enderchest_interface_click_main_stoneblock run clear @s minecraft:gray_stained_glass_pane[custom_model_data=2]
...
#Sky
execute as @a[scores={elements_enderchest_interface_number=8,elements_enderchest_settings_tp-mode=1}] store result score @s elements_enderchest_interface_click_main_skyblock run clear @s minecraft:light_blue_stained_glass_pane[custom_model_data=2]
...
#Nether
execute as @a[scores={elements_enderchest_interface_number=8,elements_enderchest_settings_tp-mode=1}] store result score @s elements_enderchest_interface_click_main_netherblock run clear @s minecraft:red_stained_glass_pane[custom_model_data=2]
...
#Ocean
execute as @a[scores={elements_enderchest_interface_number=8,elements_enderchest_settings_tp-mode=1}] store result score @s elements_enderchest_interface_click_main_oceanblock run clear @s minecraft:blue_stained_glass_pane[custom_model_data=2]
...
#Hub 
execute as @a[scores={elements_enderchest_interface_number=8,elements_enderchest_settings_tp-mode=1..2}] store result score @s elements_enderchest_interface_click_main_hub run clear @s minecraft:nether_star[custom_model_data=1]
...
execute as @a[scores={elements_enderchest_level_tp=2,elements_enderchest_interface_number=8,elements_enderchest_settings_tp-mode=3}] store result score @s elements_enderchest_interface_click_main_dimension run clear @s minecraft:nether_star[custom_model_data=2]
...
execute as @a[scores={elements_enderchest_level_tp=2,elements_enderchest_interface_number=8,elements_enderchest_settings_tp-mode=2..3}] store result score @s elements_enderchest_interface_click_main_dimension run clear @s minecraft:red_stained_glass_pane[custom_model_data=2]
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] run scoreboard players add @s elements_enderchest_settings_dimension 1
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] run scoreboard players set @s elements_enderchest_interface_click_main_dimension 0
execute as @a[scores={elements_enderchest_level_tp=2,elements_enderchest_interface_number=8,elements_enderchest_settings_tp-mode=2..3}] store result score @s elements_enderchest_interface_click_main_dimension run clear @s minecraft:blue_stained_glass_pane[custom_model_data=2]
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] run scoreboard players add @s elements_enderchest_settings_dimension 1
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] run scoreboard players set @s elements_enderchest_interface_click_main_dimension 0
execute as @a[scores={elements_enderchest_level_tp=2,elements_enderchest_interface_number=8,elements_enderchest_settings_tp-mode=2..3}] store result score @s elements_enderchest_interface_click_main_dimension run clear @s minecraft:light_blue_stained_glass_pane[custom_model_data=2]
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] run scoreboard players add @s elements_enderchest_settings_dimension 1
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] run scoreboard players set @s elements_enderchest_interface_click_main_dimension 0
execute as @a[scores={elements_enderchest_level_tp=2,elements_enderchest_interface_number=8,elements_enderchest_settings_tp-mode=2..3}] store result score @s elements_enderchest_interface_click_main_dimension run clear @s minecraft:gray_stained_glass_pane[custom_model_data=2]
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] run scoreboard players add @s elements_enderchest_settings_dimension 1
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @a[scores={elements_enderchest_interface_click_main_dimension=1}] run scoreboard players set @s elements_enderchest_interface_click_main_dimension 0

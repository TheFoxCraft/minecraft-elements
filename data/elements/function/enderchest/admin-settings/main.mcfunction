...
execute if score .server elements_setup_temp matches 1 if score .server elements_setup matches 1 as @s[scores={elements_enderchest_interface_number=8,elements_rank_admin=1}] run item replace entity @s enderchest.13 with air
execute if score .server elements_setup_temp matches 1 if score .server elements_setup matches 1 run tellraw @s ["",{"translate":"elements.main.other.server","color": "yellow"},{"text": "Der Energiekern, der die Welten zusammenhält wird aktiviert!"}]
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 40 in elements:hub positioned 0 101 0 run spreadplayers ~ ~ 1 10 under 101 false @s
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 40 as @s at @s run tp @s ~ ~ ~ facing entity @n[tag=start_warden]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 80 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Soso, sieh mal einer an. Ihr Spieler denkt doch nicht wirklich, dass ihr allein die Macht über die Welt habt!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 220 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "ICH habe auch Interesse an dem Energiekern und ich werde ihn mir holen!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 300 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Hinter mir stehen alle Tiere der Natur!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 350 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Ihr habt keine Chance!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 420 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Aber wenn ich schon den Energiekern habe, dann braucht ihr doch den HUB auch nicht oder?"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 520 run tellraw @s ["",{"text": "Steinmetz: ","color": "yellow"},{"text": "Warte? Was soll das heißen!?"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 600 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Na, weg mit dem Laden hier!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 670 run tellraw @s ["",{"translate":"elements.villager.clementius.name.chat","color": "yellow"},{"text": "Oje, das klingt garnicht gut! Da verschwinde ich lieber von hier!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 700 as @e[tag=start_clementius] at @s run particle minecraft:portal ~ ~0.5 ~ 0.3 0.5 0.3 3 10000 force @s
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 770 run tellraw @s ["",{"translate":"elements.villager.titus.name.chat","color": "yellow"},{"text": "Warte ich komme mit!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 800 as @e[tag=start_titus] at @s run particle minecraft:portal ~ ~0.5 ~ 0.3 0.5 0.3 3 10000 force @s
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 870 run tellraw @s ["",{"translate":"elements.villager.mystery.name.chat","color": "yellow"},{"text": "Ich auch!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 900 as @e[tag=start_mystery] at @s run particle minecraft:portal ~ ~0.5 ~ 0.3 0.5 0.3 3 10000 force @s
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 970 run tellraw @s ["",{"text": "Steinmetz: ","color": "yellow"},{"text": "Sorry Leute, ich verlasse euch auch, aber ich komme zurück um euch zu helfen, wenn die Gefahr vorbei ist, versprochen!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 1000 as @e[tag=start_steinmetz] at @s run particle minecraft:portal ~ ~0.5 ~ 0.3 0.5 0.3 3 10000 force @s
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 1100 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Hahaha! Jetzt seid ihr komplett auf Euch Allein gestellt!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 1180 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Ich werde den Energiekern an mich nehmen, ihr werdet ihn nie wieder sehen!"}]

#execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 1270 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Los! Kommt und räumt den Laden leer!"}]
...
#execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 1330 as @e[tag=start_allay] at @s run particle minecraft:portal ~ ~ ~ 0.3 0.3 0.3 0 100 force @s
...
#execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 1350 as @e[tag=start_fox] at @s run particle minecraft:portal ~ ~ ~ 0.3 0.3 0.3 0 100 force @s
...
#execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 1900 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "So, jetzt wurden all eure Special Items geklaut! Mal sehen wie ihr ohne sie zurechtkommt!"}]
...
#execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 2000 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Füchse, Allays ihr geht jetzt besser..."}]
#execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 2000..2202 as @e[tag=start_itemsteal,limit=1] at @s run particle minecraft:portal ~ ~ ~ 0.3 0.3 0.3 0 500 force @s
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 2250 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Soo, aber jetzt jagen wir den Laden hier erstmal in die Luft!"}]
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 2350 as @e[tag=start_creeper] at @s run particle minecraft:portal ~ ~ ~ 0.3 0.3 0.3 0 100 force @s
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 2400 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Muhahaha!"}]
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 2500 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Was wollt ihr jetzt tun?"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 2580 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Zack! Mein Energiekern!"}]
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 2660 run tellraw @s ["",{"text": "Warden: ","color": "yellow"},{"text": "Und viel Spaß wie ihr jetzt zurechtkommt!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 2670 as @e[tag=start_warden] at @s run particle minecraft:portal ~ ~0.5 ~ 0.3 0.5 0.3 3 10000 force @s
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 2900 run tellraw @s ["",{"text": "Steinmetz: ","color": "yellow"},{"text": "Psst.. Ich glaub die sind jetzt weg"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3000 run tellraw @s ["",{"text": "Steinmetz: ","color": "yellow"},{"text": "Aber auch wenn die Gefahr jetzt weg ist, braucht ihr nicht meinen, dass ich, so wie der HUB jetzt aussieht, zurückkomme!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3100 run tellraw @s ["",{"text": "Steinmetz: ","color": "yellow"},{"text": "Repariert erstmal meinen Platz und dann sehen wir weiter!"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3200 run tellraw @s ["",{"translate":"elements.main.other.server","color": "yellow"},{"text": "Ihr könnt jetzt eure Klasse wählen, um aufzubauen, was der Warden zerstört hat."}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3300 run tellraw @s ["",{"translate":"elements.main.other.server","color": "yellow"},{"text": "Los gehts"}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3310 run title @s times 20t 200t 20t
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3310 run title @s title {"text": "MINECRAFT ELEMENTS","color": "dark_purple"}
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3310 as @s at @s run playsound ui.toast.challenge_complete master @s ~ ~ ~ 1000 0 1
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3310 run title @s subtitle {"text": "Community Edition by TheFoxCraft","color": "gold"}
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3390 run title @s subtitle {"text": "Viel Spaß","color": "gold"}

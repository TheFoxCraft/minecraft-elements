...
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.2 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.3 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.4 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.5 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.6 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.7 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.8 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.18 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.19 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.20 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.21 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.22 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.23 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.24 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @a[scores={elements_enderchest_interface_number=8,elements_admin_config_interface=1}] run item replace entity @s enderchest.25 with black_stained_glass_pane[custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 670 run tellraw @a ["",{"translate":"elements.villager.clementius.name.chat","color": "yellow"},{"text": "Oje, das klingt garnicht gut! Da verschwinde ich lieber von hier!"}]
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 770 run tellraw @a ["",{"translate":"elements.villager.titus.name.chat","color": "yellow"},{"text": "Warte ich komme mit!"}]
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 870 run tellraw @a ["",{"translate":"elements.villager.mystery.name.chat","color": "yellow"},{"text": "Ich auch!"}]
...
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3200 run tellraw @a ["",{"translate":"elements.main.other.server","color": "yellow"},{"text": "Ihr könnt jetzt eure Klasse wählen, um aufzubauen, was der Warden zerstört hat."}]
execute if score .server elements_setup matches 2 if score .server elements_setup_timer matches 3300 run tellraw @a ["",{"translate":"elements.main.other.server","color": "yellow"},{"text": "Los gehts"}]

...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=500..}] run loot give @s loot elements:items/shops/nether/hot_lava
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..199}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..199}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Du hast zu wenig Level","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=200..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=200..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=200..}] run give @s nether_wart 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=200..}] run xp add @s -200 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..4}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..4}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Du hast zu wenig Level","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=5..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=5..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=5..}] run give @s quartz 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=5..}] run xp add @s -5 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=50..}] run give @s blaze_rod 1
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=50..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=50..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=50..}] run give @s ender_pearl 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=50..}] run xp add @s -50 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..999}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..999}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Du hast zu wenig Level","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=1000..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=1000..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=1000..}] run give @s wither_skeleton_skull 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=1000..}] run xp add @s -1000 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..9}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..9}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Du hast zu wenig Level","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=10..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=10..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=10..}] run loot give @s loot elements:items/shops/nether/small_heal_pot
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=10..}] run xp add @s -10 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=50..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=50..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=50..}] run loot give @s loot elements:items/shops/nether/big_heal_pot
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=50..}] run xp add @s -50 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..249}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..249}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Du hast zu wenig Level","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=250..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=250..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=250..}] run give @s ancient_debris 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=250..}] run xp add @s -250 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..1999}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..1999}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Du hast zu wenig Level","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=2000..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=2000..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=2000..}] run give @s netherite_upgrade_smithing_template 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=2000..}] run xp add @s -2000 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0

...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=500..}] run loot give @s loot elements:items/shops/stone/rettungs_plattform
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..89}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..89}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Du hast zu wenig Level","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] run give @s raw_iron_block 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] run xp add @s -90 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] run give @s raw_copper_block 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] run xp add @s -90 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] run give @s raw_gold_block 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=90..}] run xp add @s -90 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_number=9}] store result score @s elements_enderchest_interface_clicked run clear @s minecraft:redstone_block[custom_model_data=2]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..44}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..44}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Du hast zu wenig Level","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=45..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=45..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=45..}] run give @s redstone_block 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=45..}] run xp add @s -45 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..99}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=..99}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Du hast zu wenig Level","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=100..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=100..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=100..}] run give @s diamond 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=100..}] run xp add @s -100 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=500..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=500..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=500..}] run loot give @s loot elements:items/shops/stone/leveltrank
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=500..}] run xp add @s -500 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
...
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=500..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=500..}] run tellraw @s [{"text": "Shop: ","color": "yellow"},{"text": "Gekauft!","color": "white"}]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=500..}] run loot give @s loot elements:items/shops/stone/hastetrank
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_mainlevel=500..}] run xp add @s -500 levels
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0

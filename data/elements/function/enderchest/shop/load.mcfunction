...
execute if score #server elements_enderchest_shop_ocean matches 1 run scoreboard players set @s elements_enderchest_shop_ocean 1
execute if score #server elements_enderchest_shop_stone matches 1 run scoreboard players set @s elements_enderchest_shop_stone 1
execute if score #server elements_enderchest_shop_sky matches 1 run scoreboard players set @s elements_enderchest_shop_sky 1
execute if score #server elements_enderchest_shop_nether matches 1 run scoreboard players set @s elements_enderchest_shop_nether 1

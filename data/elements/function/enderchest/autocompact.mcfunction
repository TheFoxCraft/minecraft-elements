...
execute as @s[scores={elements_enderchest_level_autocompact=6..,elements_enderchest_interface_number=2}] unless score @s elements_autocompactor matches 6 run item replace entity @s enderchest.14 with cocoa_beans[custom_name='{"color":"red","text":"Kakao Auto-Compactor","italic": false}',lore=['{"color":"green","text":"Klicke zum Aktivieren","italic": false}'],custom_model_data=12] 1
execute as @s[scores={elements_enderchest_level_autocompact=6..,elements_enderchest_interface_number=2}] if score @s elements_autocompactor matches 6 run item replace entity @s enderchest.14 with red_dye[custom_name='{"color":"green","text":"Kakao Auto-Compactor","italic": false}',lore=['{"color":"red","text":"Klicke zum Deaktivieren","italic": false}'],custom_model_data=1] 1

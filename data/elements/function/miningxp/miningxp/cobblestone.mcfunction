execute unless score @s elements_homedimension = @s elements_dimension run return run scoreboard players remove @s elements_miningxp_mining_mine-get_cobblestone 1
scoreboard players remove @s elements_miningxp_mining_mine-get_cobblestone 1
...
execute at @s if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @n[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}}] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}

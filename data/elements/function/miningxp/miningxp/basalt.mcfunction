...
execute at @s if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @n[type=item,nbt={Item:{id:"minecraft:basalt",count:1}}] run summon item ~ ~ ~ {Item:{id:"minecraft:basalt",count:1}}

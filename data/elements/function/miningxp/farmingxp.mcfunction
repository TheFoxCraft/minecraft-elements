#wrong
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] run scoreboard players add @s elements_miningxp_foresting_xp 3
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..,elements_custom-items_shop_foraging-frucht_enable=1}] run scoreboard players add @s elements_custom-items_shop_foraging-frucht_counter 1
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] store result score @s elements_miningxp_foresting_loot run random value 1..20
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] store result score @s elements_miningxp_foresting_loot run random value 21..40
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] store result score @s elements_miningxp_foresting_loot run random value 41..60
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] store result score @s elements_miningxp_foresting_loot run random value 61..80
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] store result score @s elements_miningxp_foresting_loot run random value 81..100
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..,elements_miningxp_foresting_level=..99}] run title @s actionbar ["",{"text":"🔨 Farming: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_xp"},"color":"blue"},{"text":"/","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_nextlevel"},"color":"blue"},{"text":" XP","color":"blue"}]
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..,elements_miningxp_foresting_level=100}] run title @s actionbar ["",{"text":"🔨 Farming: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_xp"},"color":"blue"},{"text":" XP","color":"blue"}]
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] run scoreboard players remove @s elements_miningxp_foresting_mine-get_oak 1
...
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..}] store result score @s elements_miningxp_foresting_loot run random value 1..20
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..}] store result score @s elements_miningxp_foresting_loot run random value 21..40
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..}] store result score @s elements_miningxp_foresting_loot run random value 41..60
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..}] store result score @s elements_miningxp_foresting_loot run random value 61..80
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..}] store result score @s elements_miningxp_foresting_loot run random value 81..100
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..,elements_miningxp_foresting_level=..99}] run title @s actionbar ["",{"text":"🔨 Farming: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_xp"},"color":"blue"},{"text":"/","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_nextlevel"},"color":"blue"},{"text":" XP","color":"blue"}]
execute as @a[scores={elements_miningxp_foresting_mine-get_spruce=1..,elements_miningxp_foresting_level=100}] run title @s actionbar ["",{"text":"🔨 Farming: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_xp"},"color":"blue"},{"text":" XP","color":"blue"}]
...
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] run scoreboard players add @s elements_miningxp_foresting_xp 3
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..,elements_custom-items_shop_foraging-frucht_enable=1}] run scoreboard players add @s elements_custom-items_shop_foraging-frucht_counter 1
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] store result score @s elements_miningxp_foresting_loot run random value 1..20
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:dark_oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:dark_oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] store result score @s elements_miningxp_foresting_loot run random value 21..40
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:dark_oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:dark_oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] store result score @s elements_miningxp_foresting_loot run random value 41..60
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:dark_oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:dark_oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] store result score @s elements_miningxp_foresting_loot run random value 61..80
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:dark_oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:dark_oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] store result score @s elements_miningxp_foresting_loot run random value 81..100
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:dark_oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:dark_oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..,elements_miningxp_foresting_level=..99}] run title @s actionbar ["",{"text":"🔨 Farming: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_xp"},"color":"blue"},{"text":"/","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_nextlevel"},"color":"blue"},{"text":" XP","color":"blue"}]
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..,elements_miningxp_foresting_level=100}] run title @s actionbar ["",{"text":"🔨 Farming: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_xp"},"color":"blue"},{"text":" XP","color":"blue"}]
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] run scoreboard players remove @s elements_miningxp_foresting_mine-get_dark_oak 1
...
execute as @a if score @s elements_miningxp_farming_xp >= @s elements_miningxp_farming_nextlevel unless score @s elements_miningxp_farming_level matches 101.. run tellraw @s ["",{"text":"Du bist im Farming-Level aufgestiegen: Level ","bold":true,"color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_farming_level"},"bold":true,"color":"blue"}]
execute as @a[scores={elements_miningxp_farming_level=100}] if score @s elements_miningxp_farming_xp >= @s elements_miningxp_farming_nextlevel unless score @s elements_miningxp_farming_level matches 101.. run tellraw @s ["",{"text":"Herzlichen Glückwünsch!","bold":true,"color":"gold"},"\n",{"text":"Du hast das Maximale Farming-Level erreicht!","bold":true,"color":"gold"}]

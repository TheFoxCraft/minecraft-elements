...
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] run scoreboard players add @s elements_miningxp_farming_xp 3
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..,elements_custom-items_shop_foraging-frucht_enable=1}] run scoreboard players add @s elements_custom-items_shop_foraging-frucht_counter 1
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] store result score @s elements_miningxp_farming_loot run random value 1..20
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] if score @s elements_miningxp_farming_level >= @s elements_miningxp_farming_loot at @e[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] store result score @s elements_miningxp_farming_loot run random value 21..40
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] if score @s elements_miningxp_farming_level >= @s elements_miningxp_farming_loot at @e[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] store result score @s elements_miningxp_farming_loot run random value 41..60
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] if score @s elements_miningxp_farming_level >= @s elements_miningxp_farming_loot at @e[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] store result score @s elements_miningxp_farming_loot run random value 61..80
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] if score @s elements_miningxp_farming_level >= @s elements_miningxp_farming_loot at @e[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] store result score @s elements_miningxp_farming_loot run random value 81..100
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] if score @s elements_miningxp_farming_level >= @s elements_miningxp_farming_loot at @e[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..,elements_miningxp_farming_level=..99}] run title @s actionbar ["",{"text":"🔨 Farming: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_farming_xp"},"color":"blue"},{"text":"/","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_farming_nextlevel"},"color":"blue"},{"text":" XP","color":"blue"}]
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..,elements_miningxp_farming_level=100}] run title @s actionbar ["",{"text":"🔨 Farming: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_farming_xp"},"color":"blue"},{"text":" XP","color":"blue"}]
#execute as @a[scores={elements_miningxp_farming_mine-get_spruce=1..}] run scoreboard players remove @s elements_miningxp_farming_mine-get_spruce 1

execute as @a[scores={elements_custom-items_shop_farming-frucht_counter=3..}] run scoreboard players add @s elements_miningxp_farming_xp 3

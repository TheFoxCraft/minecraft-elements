execute unless score @s elements_homedimension = @s elements_dimension run return run scoreboard players remove @s elements_miningxp_foresting_mine-get_spruce 1
...
execute at @s if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @n[type=item,nbt={Item:{id:"minecraft:spruce_log",count:1}}] run summon item ~ ~ ~ {Item:{id:"minecraft:spruce_log",count:1}}

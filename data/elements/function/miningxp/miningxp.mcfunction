...
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] store result score @s elements_miningxp_mining_loot run random value 1..20
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:stone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:stone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] store result score @s elements_miningxp_mining_loot run random value 21..40
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:stone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:stone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] store result score @s elements_miningxp_mining_loot run random value 41..60
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:stone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:stone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] store result score @s elements_miningxp_mining_loot run random value 61..80
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:stone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:stone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] store result score @s elements_miningxp_mining_loot run random value 81..100
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:stone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:stone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_stone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}
...
execute as @a[scores={elements_miningxp_mining_mine-get_cobblestone=1..}] store result score @s elements_miningxp_mining_loot run random value 1..20
execute as @a[scores={elements_miningxp_mining_mine-get_cobblestone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_cobblestone=1..}] store result score @s elements_miningxp_mining_loot run random value 21..40
execute as @a[scores={elements_miningxp_mining_mine-get_cobblestone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_cobblestone=1..}] store result score @s elements_miningxp_mining_loot run random value 41..60
execute as @a[scores={elements_miningxp_mining_mine-get_cobblestone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_cobblestone=1..}] store result score @s elements_miningxp_mining_loot run random value 61..80
execute as @a[scores={elements_miningxp_mining_mine-get_cobblestone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_cobblestone=1..}] store result score @s elements_miningxp_mining_loot run random value 81..100
execute as @a[scores={elements_miningxp_mining_mine-get_cobblestone=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:cobblestone",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:cobblestone",count:1}}
...
execute as @a[scores={elements_miningxp_mining_mine-get_basalt=1..}] store result score @s elements_miningxp_mining_loot run random value 1..20
execute as @a[scores={elements_miningxp_mining_mine-get_basalt=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:basalt",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:basalt",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_basalt=1..}] store result score @s elements_miningxp_mining_loot run random value 21..40
execute as @a[scores={elements_miningxp_mining_mine-get_basalt=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:basalt",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:basalt",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_basalt=1..}] store result score @s elements_miningxp_mining_loot run random value 41..60
execute as @a[scores={elements_miningxp_mining_mine-get_basalt=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:basalt",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:basalt",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_basalt=1..}] store result score @s elements_miningxp_mining_loot run random value 61..80
execute as @a[scores={elements_miningxp_mining_mine-get_basalt=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:basalt",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:basalt",count:1}}
execute as @a[scores={elements_miningxp_mining_mine-get_basalt=1..}] store result score @s elements_miningxp_mining_loot run random value 81..100
execute as @a[scores={elements_miningxp_mining_mine-get_basalt=1..}] if score @s elements_miningxp_mining_level >= @s elements_miningxp_mining_loot at @e[type=item,nbt={Item:{id:"minecraft:basalt",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:basalt",count:1}}
...
execute as @a if score @s elements_miningxp_mining_xp >= @s elements_miningxp_mining_nextlevel unless score @s elements_miningxp_mining_level matches 101.. run tellraw @s ["",{"text":"Du bist im Mining-Level aufgestiegen: Level ","bold":true,"color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_mining_level"},"bold":true,"color":"blue"}]
execute as @a[scores={elements_miningxp_mining_level=100}] if score @s elements_miningxp_mining_xp >= @s elements_miningxp_mining_nextlevel unless score @s elements_miningxp_mining_level matches 101.. run tellraw @s ["",{"text":"Herzlichen Glückwünsch!","bold":true,"color":"gold"},"\n",{"text":"Du hast das Maximale Mining-Level erreicht!","bold":true,"color":"gold"}]
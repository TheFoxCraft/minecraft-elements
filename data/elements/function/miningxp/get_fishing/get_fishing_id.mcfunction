...
$execute if score .server elements_stage matches 5 as @a[nbt={UUID:$(UUID)}] run xp add @s 36 levels
$execute if score .server elements_stage matches 5 as @a[nbt={UUID:$(UUID)},predicate=elements:is_in_hub] run xp add @s 24 levels

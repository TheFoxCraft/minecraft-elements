...
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..,elements_miningxp_foresting_level=..99}] run title @s actionbar ["",{"text":"Foraging: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_xp"},"color":"blue"},{"text":"/","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_nextlevel"},"color":"blue"},{"text":" XP","color":"blue"}]
execute as @a[scores={elements_miningxp_foresting_mine-get_oak=1..,elements_miningxp_foresting_level=100}] run title @s actionbar ["",{"text":"Foraging: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_xp"},"color":"blue"},{"text":" XP","color":"blue"}]
...
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..}] if score @s elements_miningxp_foresting_level >= @s elements_miningxp_foresting_loot at @e[type=item,nbt={Item:{id:"minecraft:dark_oak_log",count:1}},limit=1,sort=nearest] run summon item ~ ~ ~ {Item:{id:"minecraft:dark_oak_log",count:1}}
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..,elements_miningxp_foresting_level=..99}] run title @s actionbar ["",{"text":"Foraging: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_xp"},"color":"blue"},{"text":"/","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_nextlevel"},"color":"blue"},{"text":" XP","color":"blue"}]
execute as @a[scores={elements_miningxp_foresting_mine-get_dark_oak=1..,elements_miningxp_foresting_level=100}] run title @s actionbar ["",{"text":"Foraging: ","color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_xp"},"color":"blue"},{"text":" XP","color":"blue"}]
...
execute as @a if score @s elements_miningxp_foresting_xp >= @s elements_miningxp_foresting_nextlevel unless score @s elements_miningxp_foresting_level matches 101.. run tellraw @s ["",{"text":"Du bist im Foraging-Level aufgestiegen: Level ","bold":true,"color":"blue"},{"score":{"name":"@s","objective":"elements_miningxp_foresting_level"},"bold":true,"color":"blue"}]
execute as @a[scores={elements_miningxp_foresting_level=100}] if score @s elements_miningxp_foresting_xp >= @s elements_miningxp_foresting_nextlevel unless score @s elements_miningxp_foresting_level matches 101.. run tellraw @s ["",{"text":"Herzlichen Glückwünsch!","bold":true,"color":"gold"},"\n",{"text":"Du hast das Maximale Foraging-Level erreicht!","bold":true,"color":"gold"}]

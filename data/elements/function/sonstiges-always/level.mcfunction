...
# anti cheat stage 5
execute as @s[scores={elements_level_melon_placed=1..,elements_mainlevel=0}] if score .server elements_stage matches 5.. run damage @s 5
execute as @s[scores={elements_level_melon_placed=1..}] if score .server elements_stage matches 5.. run xp add @s -13 levels
execute as @s[scores={elements_level_melon_placed=1..}] run scoreboard players remove @s elements_level_melon_placed 1

...
execute as @a[scores={elements_level_stone_2=1..}] if score #server elements_stage matches 1.. if score @s elements_homedimension = @s elements_dimension run xp add @s 10 points
...
execute as @a[scores={elements_level_stone_3=1..}] if score #server elements_stage matches 1.. if score @s elements_homedimension = @s elements_dimension run xp add @s 10 points
...
execute as @a[scores={elements_level_wood_2=1..}] if score #server elements_stage matches 2.. if score @s elements_homedimension = @s elements_dimension run xp add @s 1 levels
...
execute as @a[scores={elements_level_wood_3=1..}] if score #server elements_stage matches 2.. if score @s elements_homedimension = @s elements_dimension run xp add @s 1 levels

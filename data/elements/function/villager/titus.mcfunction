...
execute as @a[scores={elements_titus_level=2,elements_titus_clicked=1}] run tellraw @s ["",{"text":"Titus: ","color":"yellow"},{"text":"Hast du die 32 Komprimierten Bruchstein?"},"\n","\n",{"text":"Ja!","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger just-ignore set 107"}}]
...
execute as @a[scores={elements_titus_level=3,elements_titus_clicked=1}] run tellraw @s ["",{"text":"Titus: ","color":"yellow"},{"text":"Jetzt noch die 70 Level!."},"\n","\n",{"text":"Hier sind sie!","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger just-ignore set 108"}}]
...
execute as @a[scores={elements_titus_level=4,elements_titus_clicked=1}] run tellraw @s ["",{"text":"Titus: ","color":"yellow"},{"text":"Soso, du willst also noch mehr!"},"\n","\n",{"text":"Hast du noch etwas für mich?","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger just-ignore set 109"}}]
...
execute as @a[scores={elements_titus_level=5,elements_titus_clicked=1}] run tellraw @s ["",{"text":"Titus: ","color":"yellow"},{"text":"Hast du alles dabei? Gut. Fangen wir mit den 64 Compressed Cobblestone an."},"\n","\n",{"text":"Ja!","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger just-ignore set 113"}}]
...
execute as @a[scores={elements_titus_level=6,elements_titus_clicked=1}] run tellraw @s ["",{"text":"Titus: ","color":"yellow"},{"text":"Jetzt noch die 100 Level!."},"\n","\n",{"text":"Hier sind sie!","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger just-ignore set 114"}}]
...
execute as @a[scores={elements_titus_level=9,elements_titus_clicked=1}] run tellraw @s ["",{"text":"Titus: ","color":"yellow"},{"text":"Hast du schon alles? Gut, fangen wir mit den 64 Komprimiertem Holz an."},"\n","\n",{"text":"Bitteschön!","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger just-ignore set 120"}}]
...
execute as @a[scores={elements_titus_level=10,elements_titus_clicked=1}] run tellraw @s ["",{"text":"Titus: ","color":"yellow"},{"text":"Jetzt noch die 1.000 Level!."},"\n","\n",{"text":"Hier sind sie!","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger just-ignore set 121"}}]

...
execute as @s[scores={elements_titus_level=13,z_just-ignore=125,elements_mainlevel=2000..}] at @s if entity @e[type=villager,tag=titus,distance=..10] run xp add @s -1000 levels

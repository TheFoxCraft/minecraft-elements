...
loot replace entity @n[tag=spawning_stage-6_main] weapon.mainhand loot elements:items/boss_spawing/stage_5
...
data modify entity @n[tag=stage-6_main] Offers.Recipes.[1].buy.count set value 64

...
execute as @a[scores={just-ignore=301,elements_mainlevel=1000..}] at @s if entity @e[type=villager,tag=mystery,distance=..10] run scoreboard players add .server elements_mystery_lootbox_jackpot 500
execute as @a[scores={just-ignore=301,elements_mainlevel=1000..}] at @s if entity @e[type=villager,tag=mystery,distance=..10] in elements:hub run summon firework_rocket -14.5 101.00 -10.5 {FireworksItem:{id:"minecraft:firework_rocket",count:1,components:{"minecraft:fireworks":{explosions:[{shape:"burst",has_twinkle:true,has_trail:true,colors:[I;16711680,65280,255]}]}}}}
execute as @a[scores={just-ignore=301,elements_mainlevel=1000..}] at @s if entity @e[type=villager,tag=mystery,distance=..10] unless score @s elements_stats_lootbox matches 100 run tellraw @s ["","\n",{"text":"Mystery: ","color":"yellow"},{"text":"Gekauft! Möchtest du erneut eine Lootbox für "},{"text": "1000 Level","color": "green"},{"text": " kaufen? Jetzt sind "},{"score": {"name": ".server","objective": "elements_mystery_lootbox_jackpot"},"color": "green"},{"text": " Level","color": "green"},{"text": " im Pot."},"\n","\n",{"text":"Kaufen!","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger just-ignore set 301"}}]
execute as @a[scores={just-ignore=301,elements_mainlevel=1000..}] at @s if entity @e[type=villager,tag=mystery,distance=..10] run function elements:villager/mystery/randomizer with entity @s
#casino
execute as @a[scores={just-ignore=301,elements_mainlevel=1000..}] at @s if entity @e[type=villager,tag=mystery,distance=..10] if score @s elements_stats_lootbox matches 100 run tellraw @s ["","\n",{"text":"Mystery: ","color":"yellow"},{"text":"Gekauft! Das war schon deine 100. Lootbox, du scheinst Glücksspiel ja zu mögen!"},"\n",{"text": "Deswegen habe ich etwas für dich! Und zwar ein Casino IN deiner Endertruhe."},"\n","\n",{"text":"Oha, Das klingt sehr cool!","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger just-ignore set 302"}}]

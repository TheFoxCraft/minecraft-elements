...
$execute in elements:hub run summon item -14.5 101.7 -8.50 {Tags:["mystery_loot","mystery_loot_handle"],Item:{id:"rotten_flesh"},Owner:$(UUID),Age:-1,PickupDelay:20,Invulnerable:1b}

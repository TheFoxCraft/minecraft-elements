...
execute as @s[scores={elements_techniker_level=6,z_just-ignore=13,elements_inv_bonemeal=16..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Sehr gut! Um all das Grünzeug anzubauen musstest du sicher Felder bestellen. Durch die Feldarbeit kannst du auch deine Farming-Fähigkeiten leveln. Hierbei erhältst du ebenfalls einen höheren Ertrag bei einigen Pflanzen, je höher dein Farming-Level ist."}]
execute as @s[scores={elements_techniker_level=6,z_just-ignore=13,elements_inv_bonemeal=16..}] run clear @s bone_meal 16
execute as @s[scores={elements_techniker_level=6,z_just-ignore=13,elements_inv_bonemeal=16..}] run scoreboard players set @s elements_techniker_level 7
execute as @s[scores={elements_techniker_level=6,z_just-ignore=13,elements_inv_bonemeal=..15}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Knochenmehl!"}]

...
execute as @a[scores={elements_techniker_level=0,z_just-ignore=5}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Außderdem solltest du wissen, dass du vorerst gestrandet bist. Es besteht derzeit keine Möglichkeit, Kontakt zu den anderen Dimensionen herzustellen."},"\n","\n",{"text":"Wie können wir das ändern?","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger z_just-ignore set 6"}}]
execute as @a[scores={z_just-ignore=5}] run scoreboard players set @s z_just-ignore 0
execute as @a[scores={elements_techniker_level=0,z_just-ignore=6}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Hilf mir ein wenig, und ich kann möglicherweise wieder eine Verbindung herstellen"},"\n","\n",{"text":"Was muss ich tun?","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger z_just-ignore set 7"}}]
execute as @a[scores={z_just-ignore=6}] run scoreboard players set @s z_just-ignore 0
execute as @a[scores={elements_techniker_level=0,z_just-ignore=7}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Ich benötige einige Ressourcen, und dann können wir weitersehen."},"\n","\n",{"text":"Ich bin dabei!","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger z_just-ignore set 8"}}]
execute as @a[scores={z_just-ignore=7}] run scoreboard players set @s z_just-ignore 0
execute as @a[scores={elements_techniker_level=0,z_just-ignore=8,elements_homedimension=1..3}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Bringe mir zu Beginn 200 Bruchstein. Und übrigens, bevor ich es vergesse, hier eine kleine Starterbox, damit du in dieser Dimension überleben kannst"}]
execute as @a[scores={elements_techniker_level=0,z_just-ignore=8,elements_homedimension=1..3}] run scoreboard players set @s elements_techniker_level 1
execute as @a[scores={elements_techniker_level=0,z_just-ignore=8,elements_homedimension=1..3}] run scoreboard players set @s z_just-ignore 0
execute as @a[scores={elements_techniker_level=0,z_just-ignore=8,elements_homedimension=4}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Bringe mir zu Beginn 200 Basalt. Und übrigens, bevor ich es vergesse, hier eine kleine Starterbox, damit du in dieser Dimension überleben kannst"}]
execute as @a[scores={elements_techniker_level=0,z_just-ignore=8,elements_homedimension=4}] run scoreboard players set @s elements_techniker_level 1
execute as @a[scores={z_just-ignore=8}] run scoreboard players set @s z_just-ignore 0
execute as @a[scores={elements_techniker_level=1,elements_homedimension=1}] run loot give @s loot elements:items/other/starter_box/ocean
execute as @a[scores={elements_techniker_level=1,elements_homedimension=2..3}] run loot give @s loot elements:items/other/starter_box/stone_sky
execute as @a[scores={elements_techniker_level=1,elements_homedimension=4}] run loot give @s loot elements:items/other/starter_box/nether
...
execute as @a[scores={elements_techniker_level=2,elements_homedimension=1..3,z_just-ignore=9,elements_inv_cobblestone=200..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Wunderbar! Und du wirst bemerkt haben, dass du deine Mining-Fähigkeiten leveln kannst. Je höher dein Mininglevel ist, desto mehr Steine erhältst du beim Abbau. Jedes Level erhöht die Dropmenge um 5% (Additiv). Ab Level 20 verdoppelt sich die Anzahl der Steine, ab Level 40 verdreifacht sie sich und so weiter"}]
execute as @a[scores={elements_techniker_level=2,elements_homedimension=1..3,z_just-ignore=9,elements_inv_cobblestone=200..}] run clear @s cobblestone 200
execute as @a[scores={elements_techniker_level=2,elements_homedimension=1..3,z_just-ignore=9,elements_inv_cobblestone=200..}] run scoreboard players set @s elements_techniker_level 3
execute as @a[scores={elements_techniker_level=2,elements_homedimension=1..3,z_just-ignore=9,elements_inv_cobblestone=..199}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Stein!"}]
execute as @a[scores={z_just-ignore=9,elements_homedimension=1..3}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=2,elements_homedimension=4,z_just-ignore=9,elements_inv_basalt=200..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Wunderbar! Und du wirst bemerkt haben, dass du deine Mining-Fähigkeiten leveln kannst. Je höher dein Mininglevel ist, desto mehr Steine erhältst du beim Abbau. Jedes Level erhöht die Dropmenge um 5% (Additiv). Ab Level 20 verdoppelt sich die Anzahl der Steine, ab Level 40 verdreifacht sie sich und so weiter"}]
execute as @a[scores={elements_techniker_level=2,elements_homedimension=4,z_just-ignore=9,elements_inv_basalt=200..}] run clear @s basalt 200
execute as @a[scores={elements_techniker_level=2,elements_homedimension=4,z_just-ignore=9,elements_inv_basalt=200..}] run scoreboard players set @s elements_techniker_level 3
execute as @a[scores={elements_techniker_level=2,elements_homedimension=4,z_just-ignore=9,elements_inv_basalt=..199}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Basalt!"}]
execute as @a[scores={z_just-ignore=9}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=3,z_just-ignore=10}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Ich warte hier so lange."}]
execute as @a[scores={elements_techniker_level=3,z_just-ignore=10}] run scoreboard players set @s elements_techniker_level 4
execute as @a[scores={z_just-ignore=10}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=4,z_just-ignore=11,elements_inv_oaklog=100..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Wir machen Fortschritte! Du hast sicherlich auch bemerkt, dass du durch das fällen von Bäumen auch deine Fähigkeiten als Waldarbeiter levelst. Bei einigen Holzsorten erhöht das Level deinen Ertrag."}]
execute as @a[scores={elements_techniker_level=4,z_just-ignore=11,elements_inv_oaklog=100..}] run clear @s oak_log 100
execute as @a[scores={elements_techniker_level=4,z_just-ignore=11,elements_inv_oaklog=100..}] run scoreboard players set @s elements_techniker_level 5
execute as @a[scores={elements_techniker_level=4,z_just-ignore=11,elements_inv_oaklog=..99}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Eichenstämme!"}]
execute as @a[scores={z_just-ignore=11}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=5,z_just-ignore=12}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Ich warte hier so lange."}]
execute as @a[scores={elements_techniker_level=5,z_just-ignore=12}] run scoreboard players set @s elements_techniker_level 6
execute as @a[scores={z_just-ignore=12}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=6,z_just-ignore=13,elements_inv_bonemeal=16..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Sehr gut! Um all das Grünzeug anzubauen musstest du sicher Felder bestellen. Durch die Feldarbeit kannst du auch deine Farming-Fähigkeiten leveln. Hierbei erhältst du ebenfalls einen höheren Ertrag bei einigen Pflanzen, je höher dein Farming-Level ist."}]
execute as @a[scores={elements_techniker_level=6,z_just-ignore=13,elements_inv_bonemeal=16..}] run clear @s bone_meal 16
execute as @a[scores={elements_techniker_level=6,z_just-ignore=13,elements_inv_bonemeal=16..}] run scoreboard players set @s elements_techniker_level 7
execute as @a[scores={elements_techniker_level=6,z_just-ignore=13,elements_inv_bonemeal=..15}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Knochenmehl!"}]
execute as @a[scores={z_just-ignore=13}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=7,z_just-ignore=14}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Melde dich bei mir, wenn du soweit bist."}]
execute as @a[scores={elements_techniker_level=7,z_just-ignore=14}] run scoreboard players set @s elements_techniker_level 9
execute as @a[scores={z_just-ignore=14}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=9,z_just-ignore=15,elements_mainlevel=50..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Perfekt! Ich bereite mal etwas vor."}]
execute as @a[scores={elements_techniker_level=9,z_just-ignore=15,elements_mainlevel=50..}] run xp add @s -50 levels
execute as @a[scores={elements_techniker_level=9,z_just-ignore=15,elements_mainlevel=50..}] run scoreboard players set @s elements_techniker_level 10
execute as @a[scores={elements_techniker_level=9,z_just-ignore=15,elements_mainlevel=..49}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Level!"}]
execute as @a[scores={z_just-ignore=15}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=10,z_just-ignore=16}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Öffne deine Enderkiste. Dort kannst du eine Dimension auswählen. Klickst du eine an, wirst du dorthin teleportiert."}]
execute as @a[scores={elements_techniker_level=10,z_just-ignore=16}] run scoreboard players set @s elements_enderchest_level_tp 1
execute as @a[scores={elements_techniker_level=10,z_just-ignore=16}] run scoreboard players set @s elements_enderchest_settings_tp-mode 1
execute as @a[scores={elements_techniker_level=10,z_just-ignore=16}] run scoreboard players set @s elements_techniker_level 11
execute as @a[scores={z_just-ignore=16}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=11,z_just-ignore=17}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Besorge mir einige Materialien von Monstern. Ich benötige 16 verrottetes Fleisch, 16 Knochen und 16 Schwarzpulver. Vielleicht können dir die anderen Spieler helfen, wenn es in deiner Dimension schwierig ist, all diese Dinge zu sammeln. Und vergiss nicht deine Belohnungen bei den Collections abzuholen!"}]
execute as @a[scores={elements_techniker_level=11,z_just-ignore=17}] run scoreboard players set @s elements_enderchest_level_collections 1
execute as @a[scores={elements_techniker_level=11,z_just-ignore=17}] run scoreboard players set @s elements_techniker_level 12
execute as @a[scores={z_just-ignore=17}] run scoreboard players set @s z_just-ignore 0

execute as @a[scores={elements_techniker_level=12,elements_techniker_clicked=1}] run tellraw @s ["",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Hast du 16 verrottetes Fleisch, 16 Knochen und 16 Schwarzpulver dabei?"},"\n","\n",{"text":"Ja!","italic":true,"underlined":true,"color":"gold","clickEvent":{"action":"run_command","value":"/trigger z_just-ignore set 18"}}]
...
execute as @a[scores={elements_techniker_level=12,z_just-ignore=18,elements_inv_bone=16..,elements_inv_rotten_flesh=16..,elements_inv_gunpowder=16..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Vielen Dank!"}]
execute as @a[scores={elements_techniker_level=12,z_just-ignore=18,elements_inv_bone=16..,elements_inv_rotten_flesh=16..,elements_inv_gunpowder=16..}] run scoreboard players set @s elements_techniker_level 13
execute as @a[scores={elements_techniker_level=12,z_just-ignore=18,elements_inv_bone=..15,elements_inv_rotten_flesh=..15,elements_inv_gunpowder=..15}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Materialien!"}]
execute as @a[scores={elements_techniker_level=12,z_just-ignore=18,elements_inv_bone=16..,elements_inv_rotten_flesh=..15,elements_inv_gunpowder=..15}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Materialien!"}]
execute as @a[scores={elements_techniker_level=12,z_just-ignore=18,elements_inv_bone=..15,elements_inv_rotten_flesh=16..,elements_inv_gunpowder=..15}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Materialien!"}]
execute as @a[scores={elements_techniker_level=12,z_just-ignore=18,elements_inv_bone=..15,elements_inv_rotten_flesh=..15,elements_inv_gunpowder=16..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Materialien!"}]
execute as @a[scores={elements_techniker_level=12,z_just-ignore=18,elements_inv_bone=16..,elements_inv_rotten_flesh=16..,elements_inv_gunpowder=..15}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Materialien!"}]
execute as @a[scores={elements_techniker_level=12,z_just-ignore=18,elements_inv_bone=..15,elements_inv_rotten_flesh=16..,elements_inv_gunpowder=16..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Materialien!"}]
execute as @a[scores={elements_techniker_level=12,z_just-ignore=18,elements_inv_bone=16..,elements_inv_rotten_flesh=..15,elements_inv_gunpowder=16..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Materialien!"}]
execute as @a[scores={z_just-ignore=18}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=14,z_just-ignore=19}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Ich warte derweil."}]
execute as @a[scores={elements_techniker_level=14,z_just-ignore=19}] run scoreboard players set @s elements_techniker_level 15
execute as @a[scores={z_just-ignore=19}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=15,z_just-ignore=20,elements_mainlevel=50..}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Perfekt!"}]
execute as @a[scores={elements_techniker_level=15,z_just-ignore=20,elements_mainlevel=50..}] run xp add @s -50 levels
execute as @a[scores={elements_techniker_level=15,z_just-ignore=20,elements_mainlevel=50..}] run scoreboard players set @s elements_techniker_level 16
execute as @a[scores={elements_techniker_level=15,z_just-ignore=20,elements_mainlevel=..49}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Du hast nicht genügend Level!"}]
execute as @a[scores={z_just-ignore=20}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_level=16,z_just-ignore=21}] run tellraw @s ["","\n",{"translate":"elements.villager.techniker.name.chat","color":"yellow"},{"text":"Benutze wieder die Enderkiste. Du kannst mit einer neuen Möglichkeit auch zum Villagerhub reisen."}]
execute as @a[scores={elements_techniker_level=16,z_just-ignore=21}] run scoreboard players set @s elements_techniker_level 17
execute as @a[scores={z_just-ignore=21}] run scoreboard players set @s z_just-ignore 0
...
execute as @a[scores={elements_techniker_random_type=3}] run function elements:villager/techniker_sprueche/random_fakten

...
loot give @s loot elements:items/uniques/collections/bruchstueck_der_eismauer
...
execute in elements:hub as @n[type=marker,tag=current_unique_item] at @s run summon text_display ~ ~0.65 ~ {billboard:"center",Tags:["elements_unique","elements_unique_bruchstueck_der_eismauer","elements_unique_bruchstueck_der_eismauer_name"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[1f,1f,1f]},text:'{"bold":true,"color":"gold","italic":false,"translate": "elements.item.unique.bruchstueck_der_eismauer"}',alignment:"center"}

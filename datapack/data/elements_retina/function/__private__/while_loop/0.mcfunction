...
function elements_retina:__private__/anonymous/5
...
execute if score $surfaces retina.__variable__ matches 1.. run function elements_retina:__private__/while_loop/0
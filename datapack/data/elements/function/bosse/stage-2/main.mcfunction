...
execute if score .server elements_stage_2_boss_status matches 1 unless entity @e[tag=stage-2_boss] in elements:stage-2_bossroom run place template elements:boss_room/stage_2 -20 98 -20
execute if score .server elements_stage_2_boss_status matches 1 unless entity @e[tag=stage-2_boss] in elements:stage-2_bossroom run tellraw @a[distance=0..] ["",{"translate":"elements.main.other.[","color": "gray"},{"translate":"elements.main.other.elements","color": "light_purple"},{"translate":"elements.main.other.]","color": "gray"},{"text": "Die Rießige Plasma-Blaze wurde besiegt!","color": "white"}]
execute if score .server elements_stage_2_boss_status matches 1 unless entity @e[tag=stage-2_boss] in elements:stage-2_bossroom run tellraw @a[distance=0..,tag=elements_boss_spectator] ["",{"translate":"elements.main.other.[","color": "gray"},{"translate":"elements.main.other.elements","color": "light_purple"},{"translate":"elements.main.other.]","color": "gray"},{"text": "Bosskampf Beendet! Zuschauermodus verlassen."}]
...
execute if score .server elements_stage_2_boss_status matches 1 unless entity @e[tag=stage-2_boss] in elements:stage-2_bossroom run give @a[distance=0..,nbt={Inventory:[{id:"minecraft:mace"}]},gamemode=!spectator] breeze_rod 1
execute if score .server elements_stage_2_boss_status matches 1 unless entity @e[tag=stage-2_boss] if score .server elements_custom-items_shop_boss-frucht_remain matches 1 in elements:stage-2_bossroom run setblock 0 101 -1 chest[facing=east]{LootTable:"elements:items/boss_key_with_bossfrucht/stage_2"} replace

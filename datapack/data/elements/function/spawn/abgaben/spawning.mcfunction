...
#stage 6 final room
execute if score .server elements_abgabe_stage_6 matches 3 run function elements:spawn/abgaben/stage-6_room/spawning
#final boss gang
execute if score .server elements_abgabe_final-boss_gang matches 3 run function elements:spawn/abgaben/final-boss_gang/spawning
#final boss room
execute if score .server elements_abgabe_final-boss_room matches 3 run function elements:spawn/abgaben/final-boss_room/spawning

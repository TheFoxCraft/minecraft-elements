...
item replace entity @e[limit=1,tag=casino_stats,type=armor_stand] weapon.mainhand with lectern[custom_data={elements:enderchest_item},custom_name='{"bold":true,"color":"gold","text":"Casino Stats:","italic": false}',custom_model_data=2] 1

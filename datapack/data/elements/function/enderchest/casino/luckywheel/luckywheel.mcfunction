...
execute as @s[scores={elements_casino_game_luckywheel_load=1}] run scoreboard players set @s elements_casino_interface 7
execute as @s[scores={elements_casino_game_luckywheel_load=1}] run function elements:enderchest/enderchest-clear
#load
execute as @s[scores={elements_casino_game_luckywheel_load=1}] run scoreboard players set @s elements_casino_game_luckywheel_speed 0
...
#\load
execute as @s[scores={elements_casino_game_luckywheel_load=1}] run scoreboard players set @s elements_casino_game_luckywheel_load 0
...
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=0}] store success score @s elements_enderchest_interface_clicked run clear @s purple_stained_glass_pane[custom_model_data=1]
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_casino_game_luckywheel_speed 1
...
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=..20}] run scoreboard players add @s elements_casino_game_luckywheel_spin 1
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=..20}] if score @s elements_casino_game_luckywheel_spin >= @s elements_casino_game_luckywheel_speed run scoreboard players add @s elements_casino_game_luckywheel_wheel 1
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=..20}] if score @s elements_casino_game_luckywheel_spin >= @s elements_casino_game_luckywheel_speed run playsound minecraft:block.note_block.xylophone master @s ~ ~ ~ 100 0.9
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=..20}] if score @s elements_casino_game_luckywheel_spin >= @s elements_casino_game_luckywheel_speed run scoreboard players set @s elements_casino_game_luckywheel_spin 0
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=..20,elements_casino_game_luckywheel_wheel=21..}] run scoreboard players set @s elements_casino_game_luckywheel_wheel 1
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=1..4}] store result score @s elements_casino_game_luckywheel_random run random value 1..30
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=5..9}] store result score @s elements_casino_game_luckywheel_random run random value 1..15
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=10..14}] store result score @s elements_casino_game_luckywheel_random run random value 1..10
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=14..21}] store result score @s elements_casino_game_luckywheel_random run random value 1..5
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=..20,elements_casino_game_luckywheel_random=1}] run scoreboard players add @s elements_casino_game_luckywheel_speed 1

execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=21..,elements_casino_game_luckywheel_wheel=1..20,elements_casino_game_luckywheel_win_timer=0}] at @s run playsound minecraft:entity.player.levelup master @s ~ ~ ~ 1
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=21..,elements_casino_game_luckywheel_wheel=1..20}] run scoreboard players add @s elements_casino_game_luckywheel_win_timer 1
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=21..,elements_casino_game_luckywheel_wheel=5,elements_casino_game_luckywheel_win_timer=40}] run scoreboard players set @s elements_casino_game_luckywheel_win 1
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=21..,elements_casino_game_luckywheel_wheel=15,elements_casino_game_luckywheel_win_timer=40}] run scoreboard players set @s elements_casino_game_luckywheel_win 1
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=21..,elements_casino_game_luckywheel_wheel=1..4,elements_casino_game_luckywheel_win_timer=40}] run scoreboard players set @s elements_casino_game_luckywheel_win 0
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=21..,elements_casino_game_luckywheel_wheel=6..14,elements_casino_game_luckywheel_win_timer=40}] run scoreboard players set @s elements_casino_game_luckywheel_win 0
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=21..,elements_casino_game_luckywheel_wheel=16..20,elements_casino_game_luckywheel_win_timer=40}] run scoreboard players set @s elements_casino_game_luckywheel_win 0
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=21..,elements_casino_game_luckywheel_wheel=1..20,elements_casino_game_luckywheel_win_timer=40}] run function elements:enderchest/enderchest-clear
execute as @s[scores={elements_casino_interface=7,elements_casino_game_luckywheel_speed=21..,elements_casino_game_luckywheel_wheel=1..20,elements_casino_game_luckywheel_win_timer=40}] run scoreboard players set @s elements_casino_interface 8
...
execute as @s[scores={elements_casino_interface=8}] unless entity @s[nbt={EnderItems:[{id:"minecraft:totem_of_undying",Slot:13b,components:{"minecraft:custom_model_data":1}}]}] store result storage elements_getid ID int 1 run scoreboard players get @s elements_playerid
execute as @s[scores={elements_casino_interface=8}] unless entity @s[nbt={EnderItems:[{id:"minecraft:totem_of_undying",Slot:13b,components:{"minecraft:custom_model_data":1}}]}] run function elements:enderchest/casino/luckywheel/winner2 with storage elements_getid

execute as @s[scores={elements_casino_interface=8}] store result score @s elements_enderchest_interface_clicked run clear @s minecraft:magenta_glazed_terracotta[custom_model_data=10]
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=0}] run scoreboard players operation @s elements_casino_stats_lvlverloren += @s elements_casino_game_einsatz
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=0}] run scoreboard players operation .server elements_casino_stats_lvlverloren += @s elements_casino_game_einsatz
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=0}] run scoreboard players operation @s elements_casino_stats_lvlumsatz -= @s elements_casino_game_einsatz
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=0}] run scoreboard players operation .server elements_casino_stats_lvlumsatz -= @s elements_casino_game_einsatz
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1}] run scoreboard players set @s elements_casino_game_price 9
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1}] run scoreboard players operation @s elements_casino_game_price *= @s elements_casino_game_einsatz
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1}] run scoreboard players operation @s elements_casino_stats_lvlgewonnen += @s elements_casino_game_price
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1}] run scoreboard players operation .server elements_casino_stats_lvlgewonnen += @s elements_casino_game_price
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1}] run scoreboard players operation @s elements_casino_stats_lvlumsatz += @s elements_casino_game_price
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1}] run scoreboard players operation .server elements_casino_stats_lvlumsatz += @s elements_casino_game_price
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1,elements_casino_game_einsatz=1}] run xp add @s 10 levels
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1,elements_casino_game_einsatz=5}] run xp add @s 50 levels
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1,elements_casino_game_einsatz=10}] run xp add @s 100 levels
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1,elements_casino_game_einsatz=50}] run xp add @s 500 levels
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1,elements_casino_game_einsatz=100}] run xp add @s 1000 levels
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1,elements_casino_game_einsatz=500}] run xp add @s 5000 levels
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1,elements_casino_game_einsatz=1000}] run xp add @s 10000 levels
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1,elements_casino_game_einsatz=5000}] run xp add @s 50000 levels
execute as @s[scores={elements_enderchest_interface_clicked=1,elements_casino_game_luckywheel_win=1,elements_casino_game_einsatz=10000}] run xp add @s 100000 levels

...
item replace entity @e[limit=1,tag=handelsmark_new_offer_price_buttons_load,type=armor_stand] weapon.mainhand with copper_ingot[custom_data={elements:enderchest_item},custom_name='{"bold":true,"color":"gold","text":"Preis verringern","italic": false}',custom_model_data=20] 1
...
# Preis erhöhen
execute as @s at @s run summon armor_stand ~ ~ ~ {Invisible:1b,Tags:["handelsmark_new_offer_price_buttons_load"],Invulnerable:1b,Silent:1b}
item replace entity @e[limit=1,tag=handelsmark_new_offer_price_buttons_load,type=armor_stand] weapon.mainhand with copper_ingot[custom_data={elements:enderchest_item},custom_name='{"bold":true,"color":"gold","text":"Preis erhöhen","italic": false}',custom_model_data=21] 1

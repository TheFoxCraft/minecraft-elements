...
data modify entity @n[type=armor_stand,tag=handelsmarkt_offers_load] HandItems[0].components."minecraft:custom_data" set value {handelsmarkt_item:true,elements:enderchest_item}

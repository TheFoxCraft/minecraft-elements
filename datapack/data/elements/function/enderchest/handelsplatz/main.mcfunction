...
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=0}] run item replace entity @s enderchest.8 with magenta_glazed_terracotta[custom_data={elements:enderchest_item},custom_name='{"color":"red","translate":"elements.enderchest.zurueck","italic": false}',custom_model_data=2] 1
...
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=0}] run item replace entity @s enderchest.0 with name_tag[custom_data={elements:enderchest_item},custom_name='{"color":"gold","text": "Neues Angebot","italic": false}',custom_model_data=1] 1
...
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=0}] run item replace entity @s enderchest.1 with blue_stained_glass_pane[custom_data={elements:enderchest_item},hide_tooltip={},custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=0}] run item replace entity @s enderchest.2 with blue_stained_glass_pane[custom_data={elements:enderchest_item},hide_tooltip={},custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=0}] run item replace entity @s enderchest.4 with blue_stained_glass_pane[custom_data={elements:enderchest_item},hide_tooltip={},custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=0}] run item replace entity @s enderchest.7 with blue_stained_glass_pane[custom_data={elements:enderchest_item},hide_tooltip={},custom_model_data=1] 1

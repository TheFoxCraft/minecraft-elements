...
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=1},nbt={Inventory:[{id:"minecraft:copper_ingot",components:{"minecraft:custom_model_data":20}}]}] run scoreboard players set @s elements_enderchest_interface_clicked 2
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=1},nbt={Inventory:[{id:"minecraft:copper_ingot",components:{"minecraft:custom_model_data":20}}]}] run clear @s minecraft:copper_ingot[custom_model_data=20]
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=1,elements_enderchest_interface_clicked=0}] store result score @s elements_enderchest_interface_clicked run clear @s minecraft:copper_ingot[custom_model_data=20]
...
execute as @s[scores={elements_enderchest_interface_clicked=2,elements_enderchest_handelsplatz_new_offer_price_fine=..10}] at @s run playsound minecraft:block.note_block.didgeridoo master @s ~ ~ ~ 100 0
execute as @s[scores={elements_enderchest_interface_clicked=2,elements_enderchest_handelsplatz_new_offer_price_fine=11..}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
execute as @s[scores={elements_enderchest_interface_clicked=2,elements_enderchest_handelsplatz_new_offer_price_fine=2..}] run scoreboard players remove @s elements_enderchest_handelsplatz_new_offer_price_fine 10
execute as @s[scores={elements_enderchest_interface_clicked=2,elements_enderchest_handelsplatz_new_offer_price_fine=..0}] run scoreboard players set @s elements_enderchest_handelsplatz_new_offer_price_fine 1
execute as @s[scores={elements_enderchest_interface_clicked=1..2}] run scoreboard players set @s elements_enderchest_handelsplatz_new_offer_price 10
execute as @s[scores={elements_enderchest_interface_clicked=1..2}] run scoreboard players operation @s elements_enderchest_handelsplatz_new_offer_price *= @s elements_enderchest_handelsplatz_new_offer_price_fine
execute as @s[scores={elements_enderchest_interface_clicked=1..2}] run function elements:enderchest/handelsplatz/new_offer/build_price_buttons
execute as @s[scores={elements_enderchest_interface_clicked=1..2}] run scoreboard players set @s elements_enderchest_interface_clicked 0
kill @e[type=item,nbt={Item:{id:"minecraft:copper_ingot",count:1,components:{"minecraft:custom_model_data":20}}}]

execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=1},nbt={Inventory:[{id:"minecraft:copper_ingot",components:{"minecraft:custom_model_data":21}}]}] run scoreboard players set @s elements_enderchest_interface_clicked 2
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=1},nbt={Inventory:[{id:"minecraft:copper_ingot",components:{"minecraft:custom_model_data":21}}]}] run clear @s minecraft:copper_ingot[custom_model_data=21]
execute as @s[scores={elements_enderchest_interface_number=10,elements_enderchest_handelsplatz_interface=1,elements_enderchest_interface_clicked=0}] store result score @s elements_enderchest_interface_clicked run clear @s minecraft:copper_ingot[custom_model_data=21]
execute as @s[scores={elements_enderchest_interface_clicked=1..2}] at @s run playsound ui.button.click master @s ~ ~ ~ 1
...
execute as @s[scores={elements_enderchest_interface_clicked=2}] run scoreboard players add @s elements_enderchest_handelsplatz_new_offer_price_fine 10
execute as @s[scores={elements_enderchest_interface_clicked=1..2}] run scoreboard players set @s elements_enderchest_handelsplatz_new_offer_price 10
execute as @s[scores={elements_enderchest_interface_clicked=1..2}] run scoreboard players operation @s elements_enderchest_handelsplatz_new_offer_price *= @s elements_enderchest_handelsplatz_new_offer_price_fine
execute as @s[scores={elements_enderchest_interface_clicked=1..2}] run function elements:enderchest/handelsplatz/new_offer/build_price_buttons
execute as @s[scores={elements_enderchest_interface_clicked=1..2}] run scoreboard players set @s elements_enderchest_interface_clicked 0

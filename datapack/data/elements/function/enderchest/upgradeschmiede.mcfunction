...
execute as @s[scores={elements_enderchest_level_upgradeschmiede=1,elements_enderchest_interface_number=3}] run item replace entity @s enderchest.22 with magenta_glazed_terracotta[custom_data={elements:enderchest_item},custom_name='{"color":"red","translate":"elements.enderchest.zurueck","italic": false}',custom_model_data=2] 1
...
#element bow
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":1}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_bow/rare
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":1}}]}] run xp add @s -10000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":2}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_bow/epic
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":2}}]}] run xp add @s -50000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":3}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_bow/legendary
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":3}}]}] run xp add @s -250000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":4}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_bow/mythic
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":4}}]}] run xp add @s -750000 levels

#element hoe
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:iron_hoe",components:{"minecraft:custom_model_data":1}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_hoe/rare
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:iron_hoe",components:{"minecraft:custom_model_data":1}}]}] run xp add @s -10000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_hoe",components:{"minecraft:custom_model_data":2}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_hoe/epic
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_hoe",components:{"minecraft:custom_model_data":2}}]}] run xp add @s -50000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_hoe",components:{"minecraft:custom_model_data":3}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_hoe/legendary
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_hoe",components:{"minecraft:custom_model_data":3}}]}] run xp add @s -250000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":2}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_hoe/epic
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":2}}]}] run xp add @s -50000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":3}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_hoe/legendary
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":3}}]}] run xp add @s -250000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":4}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_hoe/mythic
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":4}}]}] run xp add @s -750000 levels

#element shovel
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:iron_shovel",components:{"minecraft:custom_model_data":1}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_shovel/rare
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:iron_shovel",components:{"minecraft:custom_model_data":1}}]}] run xp add @s -10000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_shovel",components:{"minecraft:custom_model_data":2}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_shovel/epic
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_shovel",components:{"minecraft:custom_model_data":2}}]}] run xp add @s -50000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_shovel",components:{"minecraft:custom_model_data":3}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_shovel/legendary
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_shovel",components:{"minecraft:custom_model_data":3}}]}] run xp add @s -250000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":2}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_shovel/epic
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":2}}]}] run xp add @s -50000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":3}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_shovel/legendary
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":3}}]}] run xp add @s -250000 levels

execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":4}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_shovel/mythic
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":4}}]}] run xp add @s -750000 levels


#mace
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:mace",components:{"minecraft:custom_model_data":4}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_mace/mythic
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:mace",components:{"minecraft:custom_model_data":4}}]}] run xp add @s -750000 levels
...
#chestplate
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_chestplate",components:{"minecraft:custom_model_data":4}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_chestplate/mythic
...
#leggings
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_leggings",components:{"minecraft:custom_model_data":4}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_leggings/mythic
...
#boots
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_boots",components:{"minecraft:custom_model_data":4}}]}] run loot replace entity @s enderchest.14 loot elements:items/element_boots/mythic
...
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:ghast_tear",components:{"minecraft:custom_model_data":1}}]}] run xp add @s -5000 levels
...
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:ghast_tear",components:{"minecraft:custom_model_data":2}}]}] run xp add @s -25000 levels
...
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:ghast_tear",components:{"minecraft:custom_model_data":3}}]}] run xp add @s -50000 levels
...
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:gray_dye",components:{"minecraft:custom_model_data":1}}]}] run xp add @s -5000 levels
...
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:gray_dye",components:{"minecraft:custom_model_data":2}}]}] run xp add @s -25000 levels
...
execute as @s[scores={elements_enderchest_upgradeschmiede_upgrade=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:gray_dye",components:{"minecraft:custom_model_data":3}}]}] run xp add @s -50000 levels
...
#element sword
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":1}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":1}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 2
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 3
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":4}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:bow",components:{"minecraft:custom_model_data":4}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 4

#element hoe
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:iron_hoe",components:{"minecraft:custom_model_data":1}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:iron_hoe",components:{"minecraft:custom_model_data":1}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_hoe",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_hoe",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 2
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_hoe",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_hoe",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 3
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 2
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 3
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":4}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_hoe",components:{"minecraft:custom_model_data":4}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 4

#element shovel
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:iron_shovel",components:{"minecraft:custom_model_data":1}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:iron_shovel",components:{"minecraft:custom_model_data":1}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_shovel",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_shovel",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 2
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_shovel",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:diamond_shovel",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 3
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 2
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 3
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":4}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:netherite_shovel",components:{"minecraft:custom_model_data":4}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 4

#element mace
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:mace",components:{"minecraft:custom_model_data":4}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:mace",components:{"minecraft:custom_model_data":4}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 4
...
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:ghast_tear",components:{"minecraft:custom_model_data":1}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 5
...
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:ghast_tear",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 6
...
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:ghast_tear",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 7
...
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:gray_dye",components:{"minecraft:custom_model_data":1}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 5
...
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:gray_dye",components:{"minecraft:custom_model_data":2}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 6
...
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:gray_dye",components:{"minecraft:custom_model_data":3}}]}] run scoreboard players set @s elements_enderchest_upgradeschmiede_level 7
...
execute as @s[scores={elements_enderchest_interface_number=3,elements_enderchest_upgradeschmiede_level=5,elements_mainlevel=5000..,elements_enderchest_upgradeschmiede_upgrade=1}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 2
execute as @s[scores={elements_enderchest_interface_number=3,elements_enderchest_upgradeschmiede_level=6,elements_mainlevel=25000..,elements_enderchest_upgradeschmiede_upgrade=1}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 2
execute as @s[scores={elements_enderchest_interface_number=3,elements_enderchest_upgradeschmiede_level=7,elements_mainlevel=50000..,elements_enderchest_upgradeschmiede_upgrade=1}] run scoreboard players set @s elements_enderchest_upgradeschmiede_upgrade 2


execute as @s[scores={elements_enderchest_interface_number=3,elements_enderchest_upgradeschmiede_upgrade=0}] run item replace entity @s enderchest.13 with damaged_anvil[custom_data={elements:enderchest_item},custom_name='{"color":"red","strikethrough":true,"text":"Upgrade!","italic": false}',lore=['{"color":"red","text":"Ungültiges Item!","italic": false}'],custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=3,elements_enderchest_upgradeschmiede_upgrade=1}] run item replace entity @s enderchest.13 with chipped_anvil[custom_data={elements:enderchest_item},custom_name='{"color":"red","strikethrough":true,"text":"Upgrade!","italic": false}',lore=['{"color":"red","text":"Zu wenig Level!","italic": false}'],custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=3,elements_enderchest_upgradeschmiede_upgrade=2}] run item replace entity @s enderchest.13 with anvil[custom_data={elements:enderchest_item},custom_name='{"color":"gold","text":"Upgrade!","italic": false}',custom_model_data=2] 1
...
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.0 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.1 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.2 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.3 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.5 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.6 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.7 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.8 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.9 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.10 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.11 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.15 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.16 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.17 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.18 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.19 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.20 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.21 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.23 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.24 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.25 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.26 with blue_stained_glass_pane[custom_data={elements:enderchest_item},custom_name='{"translate":"elements.main.other.space"}',custom_model_data=1,hide_tooltip={}] 1
clear @s minecraft:oak_hanging_sign[custom_model_data=1]
execute as @s[scores={elements_enderchest_interface_number=3}] run item replace entity @s enderchest.4 with oak_hanging_sign[custom_data={elements:enderchest_item},custom_name='{"color":"blue","text":"Upgrade-Station Info:","italic": false}',lore=['{"text":"Element Equipment Upgrades:","italic": false}','{"translate":"elements.main.other.space"}','[{"bold":true,"color":"blue","text":"Rare:            ","italic": false},{"bold":false,"color":"green","text":"10.000 Level","italic": false}]','[{"bold":true,"color":"dark_purple","text":"Epic:             ","italic": false},{"bold":false,"color":"green","text":"50.000 Level","italic": false}]','[{"bold":true,"color":"gold","text":"Legendary:    ","italic": false},{"bold":false,"color":"green","text":"250.000 Level","italic": false}]','[{"bold":true,"color":"light_purple","text":"Mythic:         ","italic": false},{"bold":false,"color":"green","text":"750.000 Level","italic": false}]','""','{"text": "Preise können bei Manchen Items Abweichen.","color":"gray","italic":false}','{"text":"Lege dein Item in den Upgrade-Slot,","color":"dark_gray","italic":false}','{"text":"um die (falls vorhandenen) angepassten Preise zu sehen.","color":"dark_gray","italic":false}'],custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:gray_dye",components:{"minecraft:custom_model_data":1}}]}] run item replace entity @s enderchest.4 with oak_hanging_sign[custom_data={elements:enderchest_item},custom_name='{"color":"blue","text":"Upgrade-Station Info:","italic": false}',lore=['{"text":"Gravity-Stone Upgrades:","italic": false}','{"translate":"elements.main.other.space"}','[{"bold":true,"color":"dark_purple","text":"Epic:             ","italic": false},{"bold":false,"color":"green","text":"5.000 Level","italic": false}]','[{"bold":true,"color":"gold","text":"Legendary:    ","italic": false},{"bold":false,"color":"green","text":"25.000 Level","italic": false}]','[{"bold":true,"color":"light_purple","text":"Mythic:         ","italic": false},{"bold":false,"color":"green","text":"50.000 Level","italic": false}]'],custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:gray_dye",components:{"minecraft:custom_model_data":2}}]}] run item replace entity @s enderchest.4 with oak_hanging_sign[custom_data={elements:enderchest_item},custom_name='{"color":"blue","text":"Upgrade-Station Info:","italic": false}',lore=['{"text":"Gravity-Stone Upgrades:","italic": false}','{"translate":"elements.main.other.space"}','[{"bold":true,"color":"dark_purple","text":"Epic:             ","italic": false},{"bold":false,"color":"green","text":"5.000 Level","italic": false}]','[{"bold":true,"color":"gold","text":"Legendary:    ","italic": false},{"bold":false,"color":"green","text":"25.000 Level","italic": false}]','[{"bold":true,"color":"light_purple","text":"Mythic:         ","italic": false},{"bold":false,"color":"green","text":"50.000 Level","italic": false}]'],custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:gray_dye",components:{"minecraft:custom_model_data":3}}]}] run item replace entity @s enderchest.4 with oak_hanging_sign[custom_data={elements:enderchest_item},custom_name='{"color":"blue","text":"Upgrade-Station Info:","italic": false}',lore=['{"text":"Gravity-Stone Upgrades:","italic": false}','{"translate":"elements.main.other.space"}','[{"bold":true,"color":"dark_purple","text":"Epic:             ","italic": false},{"bold":false,"color":"green","text":"5.000 Level","italic": false}]','[{"bold":true,"color":"gold","text":"Legendary:    ","italic": false},{"bold":false,"color":"green","text":"25.000 Level","italic": false}]','[{"bold":true,"color":"light_purple","text":"Mythic:         ","italic": false},{"bold":false,"color":"green","text":"50.000 Level","italic": false}]'],custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:ghast_tear",components:{"minecraft:custom_model_data":1}}]}] run item replace entity @s enderchest.4 with oak_hanging_sign[custom_data={elements:enderchest_item},custom_name='{"color":"blue","text":"Upgrade-Station Info:","italic": false}',lore=['{"text":"Photon Upgrades:","italic": false}','{"translate":"elements.main.other.space"}','[{"bold":true,"color":"dark_purple","text":"Epic:             ","italic": false},{"bold":false,"color":"green","text":"5.000 Level","italic": false}]','[{"bold":true,"color":"gold","text":"Legendary:    ","italic": false},{"bold":false,"color":"green","text":"25.000 Level","italic": false}]','[{"bold":true,"color":"light_purple","text":"Mythic:         ","italic": false},{"bold":false,"color":"green","text":"50.000 Level","italic": false}]'],custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:ghast_tear",components:{"minecraft:custom_model_data":2}}]}] run item replace entity @s enderchest.4 with oak_hanging_sign[custom_data={elements:enderchest_item},custom_name='{"color":"blue","text":"Upgrade-Station Info:","italic": false}',lore=['{"text":"Photon Upgrades:","italic": false}','{"translate":"elements.main.other.space"}','[{"bold":true,"color":"dark_purple","text":"Epic:             ","italic": false},{"bold":false,"color":"green","text":"5.000 Level","italic": false}]','[{"bold":true,"color":"gold","text":"Legendary:    ","italic": false},{"bold":false,"color":"green","text":"25.000 Level","italic": false}]','[{"bold":true,"color":"light_purple","text":"Mythic:         ","italic": false},{"bold":false,"color":"green","text":"50.000 Level","italic": false}]'],custom_model_data=1] 1
execute as @s[scores={elements_enderchest_interface_number=3},nbt={EnderItems:[{Slot:12b,id:"minecraft:ghast_tear",components:{"minecraft:custom_model_data":3}}]}] run item replace entity @s enderchest.4 with oak_hanging_sign[custom_data={elements:enderchest_item},custom_name='{"color":"blue","text":"Upgrade-Station Info:","italic": false}',lore=['{"text":"Photon Upgrades:","italic": false}','{"translate":"elements.main.other.space"}','[{"bold":true,"color":"dark_purple","text":"Epic:             ","italic": false},{"bold":false,"color":"green","text":"5.000 Level","italic": false}]','[{"bold":true,"color":"gold","text":"Legendary:    ","italic": false},{"bold":false,"color":"green","text":"25.000 Level","italic": false}]','[{"bold":true,"color":"light_purple","text":"Mythic:         ","italic": false},{"bold":false,"color":"green","text":"50.000 Level","italic": false}]'],custom_model_data=1] 1

...
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
item replace entity @s enderchest.10 with globe_banner_pattern[custom_data={elements:enderchest_item},custom_name='{"color":"gold","translate": "elements.enderchest.admin_settings.tipps.fishing_rod.string.tipp.name","with": ["1"],"italic": false}',lore=['{"translate": "elements.enderchest.admin_settings.tipps.fishing_rod.tipp.description","color": "gray","italic": false}'],custom_model_data=2] 1
...
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
item replace entity @s enderchest.14 with globe_banner_pattern[custom_data={elements:enderchest_item},custom_name='{"color":"gold","translate": "elements.enderchest.admin_settings.tipps.fishing_rod.hook.tipp.name","with": ["3"],"italic": false}',lore=['{"translate": "elements.enderchest.admin_settings.tipps.fishing_rod.tipp.description","color": "gray","italic": false}'],custom_model_data=6] 1
...
execute as @s[scores={elements_enderchest_interface_clicked=1}] run scoreboard players set @s elements_enderchest_interface_clicked 0
item replace entity @s enderchest.16 with globe_banner_pattern[custom_data={elements:enderchest_item},custom_name='{"color":"gold","translate": "elements.enderchest.admin_settings.tipps.fishing_rod.crafting.tipp.name","with": ["3"],"italic": false}',lore=['{"translate": "elements.enderchest.admin_settings.tipps.fishing_rod.tipp.description","color": "gray","italic": false}'],custom_model_data=8] 1

...
execute as @s[scores={elements_enderchest_level_enderchest=1,elements_enderchest_interface_number=4}] run item replace entity @s enderchest.26 with magenta_glazed_terracotta[custom_name='{"color":"red","translate":"elements.enderchest.zurueck","italic": false}',custom_model_data=3] 1

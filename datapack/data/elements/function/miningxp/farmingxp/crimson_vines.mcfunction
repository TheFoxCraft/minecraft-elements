execute unless score @s elements_homedimension = @s elements_dimension run return run scoreboard players remove @s elements_miningxp_farming_mine-get_crimson_vines 1
...
execute as @s[scores={elements_custom-items_shop_farming-frucht_enable=1}] run scoreboard players add @s elements_custom-items_shop_farming-frucht_counter_crimson_vines 1
execute at @s store result score @s elements_miningxp_farming_loot run random value 1..20
execute at @s if score @s elements_miningxp_farming_level >= @s elements_miningxp_farming_loot at @n[type=item,nbt={Item:{id:"minecraft:crimson_roots",count:1}}] run loot spawn ~ ~ ~ loot elements:items/other/crimson_vines
...
execute as @s[scores={elements_custom-items_shop_farming-frucht_counter_crimson_vines=3..}] run scoreboard players add @s elements_miningxp_farming_xp 2
execute as @s[scores={elements_custom-items_shop_farming-frucht_counter_crimson_vines=3..}] run scoreboard players remove @s elements_custom-items_shop_farming-frucht_counter_crimson_vines 3

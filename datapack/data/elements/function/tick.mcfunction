...
execute if score .server elements_abgabe_final-boss_room matches 2 run function elements:spawn/final-boss
...
#rätsel
execute if score .server elements_stage_1_portal_enable matches 0 if score .server elements_stage matches 1.. as @e[type=item,nbt={Item:{id:"minecraft:blue_ice",components:{"minecraft:custom_model_data":1}},OnGround:1b}] at @s if block ~ ~ ~ fire run function elements:stages/stage-1/portal-enable
execute if score .server elements_stage_2_portal_enable matches 0 if score .server elements_stage matches 2.. as @e[type=item,nbt={Item:{id:"minecraft:dark_oak_sapling",components:{"minecraft:custom_model_data":1}},OnGround:1b}] at @s if entity @e[type=item,nbt={Item:{id:"minecraft:spruce_log"},OnGround:1b},distance=..0.3] if entity @e[type=item,nbt={Item:{id:"minecraft:charcoal"},OnGround:1b},distance=..0.3,] run function elements:stages/stage-2/portal-enable
...
execute if score .server elements_final-boss_portal_enable matches 1 run function elements:stages/final-boss/portal
...
execute if score .server elements_final-boss_boss_status matches 1 run function elements:bosse/final-boss/main

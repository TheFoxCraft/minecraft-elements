...
execute as @s[scores={elements_custom-items_item-click_cooldown=0}] run scoreboard players add @s elements_custom-items_shop_mining-frucht_timer_min 30
execute as @s[scores={elements_custom-items_item-click_cooldown=0}] run function elements:custom-items/mining-frucht/timer
...
execute as @s[scores={elements_custom-items_item-click_cooldown=0}] run clear @s chorus_fruit[custom_model_data=1] 1

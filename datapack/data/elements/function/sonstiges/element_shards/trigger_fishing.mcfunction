...
execute if score @s elements_element_shards_value matches 272..287 run function elements:sonstiges/element_shards/lucky_drops/mythic {rate:40000,chance:1}
execute if score @s elements_element_shards_value matches 288..303 run function elements:sonstiges/element_shards/lucky_drops/mythic {rate:40000,chance:2}
execute if score @s elements_element_shards_value matches 304..319 run function elements:sonstiges/element_shards/lucky_drops/mythic {rate:40000,chance:3}
execute if score @s elements_element_shards_value matches 320..335 run function elements:sonstiges/element_shards/lucky_drops/mythic {rate:40000,chance:4}
execute if score @s elements_element_shards_value matches 336..351 run function elements:sonstiges/element_shards/lucky_drops/mythic {rate:40000,chance:5}
execute if score @s elements_element_shards_value matches 352..367 run function elements:sonstiges/element_shards/lucky_drops/mythic {rate:40000,chance:6}
execute if score @s elements_element_shards_value matches 368..383 run function elements:sonstiges/element_shards/lucky_drops/mythic {rate:40000,chance:7}
execute if score @s elements_element_shards_value matches 384.. run function elements:sonstiges/element_shards/lucky_drops/mythic {rate:40000,chance:8}
